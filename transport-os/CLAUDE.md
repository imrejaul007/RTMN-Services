# Transport OS - Development Guide

**Port:** 5240  
**Type:** Industry OS (transport)  
**Industry:** Transport
...
|----------|-------------|----------|
| PORT | Service port | No (default: 5240) |
...
Transport OS manages complete transport operations.
...
# Register
curl -X POST http://localhost:5240/auth/register \
  -H "Content-Type: application/json" \
  -d '{"businessId":"biz_123","email":"owner@transport.com","password":"secret"}'

# Login
curl -X POST http://localhost:5240/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"owner@transport.com","password":"secret"}'
```
