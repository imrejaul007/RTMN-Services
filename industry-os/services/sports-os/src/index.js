...
industryIntegration.registerRoutes(app, 'sports', PORT);
app.listen(PORT, () => {
  console.log('✅ sports-os AI Company Platform running on port ' + PORT);
