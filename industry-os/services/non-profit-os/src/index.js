/**
 * non-profit-os AI Company Platform
 * 
...
industryIntegration.registerRoutes(app, 'nonProfit', PORT);
app.listen(PORT, () => {
  console.log('✅ non-profit-os AI Company Platform running on port ' + PORT);
