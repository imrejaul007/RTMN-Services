# Gaming OS - Development Guide

**Port:** 5120  
**Type:** Industry OS (gaming)  
**Industry:** Gaming
...
|----------|-------------|----------|
| PORT | Service port | No (default: 5120) |
...
Gaming OS manages complete gaming operations.
...
curl -X POST http://localhost:5120/auth/register \
  ...
  -d '{"businessId":"biz_123","email":"owner@gaming.com","password":"secret"}'

# Login
curl -X POST http://localhost:5120/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"owner@gaming.com","password":"secret"}'
```
