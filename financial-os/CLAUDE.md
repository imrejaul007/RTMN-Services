# Financial OS - Development Guide

**Port:** 5220  
**Type:** Industry OS (financial)  
**Industry:** Financial
...
|----------|-------------|----------|
| PORT | Service port | No (default: 5220) |
...
Financial OS manages complete financial operations.
...
# Register
curl -X POST http://localhost:5220/auth/register \
  -H "Content-Type: application/json" \
  -d '{"businessId":"biz_123","email":"owner@financial.com","password":"secret"}'

# Login
curl -X POST http://localhost:5220/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"owner@financial.com","password":"secret"}'
```
