# HomeServices OS - Development Guide

**Port:** 5140  
**Type:** Industry OS (home_services)  
...
|----------|-------------|----------|
| PORT | Service port | No (default: 5140) |
...
HomeServices OS manages complete home services operations.
...
# Register
curl -X POST http://localhost:5140/auth/register \
  -H "Content-Type: application/json" \
  -d '{"businessId":"biz_123","email":"owner@home_services.com","password":"secret"}'

# Login
curl -X POST http://localhost:5140/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"owner@home_services.com","password":"secret"}'
```
