...
| **D. ADR-0010 Multi-Tenant Federation** | Phase 0-5 done (Jun 22 2026): Repo reshape, Hub de-aliasing, Event Bus, **Business Directory** (port 4360, 68 tests) + SADA public trust API (19 tests) + shared directory client (22 tests) + **ACP-Messaging** (port 4340, 78 tests) + **Agent Marketplace** (port 4250, 109 tests). Hub wired at `/api/nexha/nexha-business-directory/*`, `/api/nexha/nexha-acp-messaging/*`, `/api/sutar/marketplace-listings/*`. Phase 6-11 in progress. See [`docs/ADR/0010-MULTI-TENANT-FEDERATION.md`](docs/ADR/0010-MULTI-TENANT-FEDERATION.md) + [`docs/nexha/PHASE-LOG.md`](docs/nexha/PHASE-LOG.md). | 🔄 |
...
> **📈 ADR-0010 Phase 5 update (2026-06-22):** +109 vitest tests added (marketplace-listings service 81 = 27 listings + 19 reviews + 35 routes; do-app marketplaceListings client 14; REZ-Workspace marketplace methods 14). New total: **721 tests, 0 failures** across all RTMN services. See [`docs/nexha/PHASE-LOG.md`](docs/nexha/PHASE-LOG.md) + [`docs/nexha/marketplace-listings.md`](docs/nexha/marketplace-listings.md).
