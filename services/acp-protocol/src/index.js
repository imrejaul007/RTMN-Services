 ...
 */
app.post('/api/negotiations/:id/quote', (req, res) => {
  try {
    const negotiation = negotiations.get(req.params.id);
    if (!negotiation) {
      return res.status(404).json({ error: 'Negotiation not found' });
 ...
 */
app.post('/api/negotiations/:id/order', (req, res) => {
  try {
    const negotiation = negotiations.get(req.params.id);
    if (!negotiation) {
      return res.status(404).json({ error: 'Negotiation not found' });
 ...
 */
app.post('/api/negotiations/:id/track', (req, res) => {
  try {
    const negotiation = negotiations.get(req.params.id);
    if (!negotiation) {
      return res.status(404).json({ error: 'Negotiation not found' });
 ...
 */
app.post('/api/negotiations/:id/dispute', (req, res) => {
  try {
    const negotiation = negotiations.get(req.params.id);
    if (!negotiation) {
      return res.status(404).json({ error: 'Negotiation not found' });
 ...
 */
app.delete('/api/messages/:agentId/:messageId', (req, res) => {
