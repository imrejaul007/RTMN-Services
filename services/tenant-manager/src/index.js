...
app.post('/api/tenants/:id/projects', (req, res) => {
  const tenant = getTenantOr404(req, res);
  if (!tenant) return;
...
app.post('/api/tenants/:id/members', (req, res) => {
  const tenant = getTenantOr404(req, res);
  if (!tenant) return;
...
app.put('/api/tenants/:id/members/:userId', (req, res) => {
  const tenant = getTenantOr404(req, res);
  if (!tenant) return;
...
app.delete('/api/tenants/:id/members/:userId', (req, res) => {
  const tenant = getTenantOr404(req, res);
  if (!tenant) return;
...
app.post('/api/tenants/:id/keys', (req, res) => {
  const tenant = getTenantOr404(req, res);
  if (!tenant) return;
...
app.delete('/api/tenants/:id/keys/:keyId', (req, res) => {
  const tenant = getTenantOr404(req, res);
  if (!tenant) return;
