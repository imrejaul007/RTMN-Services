...
const userItemAffinity = new Map();
...
function recomputeAffinity() {
  ...
  for (const e of events) {
    if (!userItemAffinity.has(e.userId)) userItemAffinity.set(e.userId, new Map());
...
function getUserRow(userId) {
  ...
  return userItemAffinity.get(userId) || new Map();
}
 ...
 */
app.post('/api/recommend/event', (req, res) => {
 ...
 */
app.post('/api/recommend/items', (req, res) => {
 ...
 */
app.post('/api/recommend/items/batch', (req, res) => {
 ...
 */
app.post('/api/nba/actions', (req, res) => {
 ...
 */
app.post('/api/decision/wsm', (req, res) => {
 ...
 */
app.post('/api/decision/topsis', (req, res) => {
