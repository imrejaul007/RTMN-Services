 ...
 */
app.post('/api/integrate/genie-shop', async (req, res) => {
  try {
 ...
 */
app.post('/api/integrate/merchant-sync', async (req, res) => {
  try {
 ...
 */
app.post('/api/integrate/contract-twin', async (req, res) => {
  try {
 ...
 */
app.post('/api/integrate/payment-rez', async (req, res) => {
  try {
