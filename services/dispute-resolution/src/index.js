 ...
 */
app.post('/api/disputes/:id/analyze', (req, res) => {
  try {
 ...
 */
app.post('/api/disputes/:id/mediate', (req, res) => {
  try {
 ...
 */
app.post('/api/mediations/:id/propose', (req, res) => {
  try {
 ...
 */
app.post('/api/arbitrations/:id/decide', (req, res) => {
  try {
