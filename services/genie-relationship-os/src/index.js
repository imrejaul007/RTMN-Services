...
// In-memory storage
const storage = {
  people: new Map(), // userId -> array of people
  interactions: new Map(), // userId -> array of interactions
  reminders: new Map(), // userId -> array of reminders
  relationshipHealth: new Map(), // userId -> relationship health data
  giftIdeas: new Map() // userId -> gift ideas
};
