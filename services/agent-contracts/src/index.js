 ...
 */
app.post('/api/contracts/from-negotiation', (req, res) => {
  try {
 ...
 */
app.post('/api/contracts/:id/fulfill', (req, res) => {
  try {
 ...
 */
app.post('/api/contracts/:id/milestones/:milestoneId', (req, res) => {
  try {
 ...
 */
app.post('/api/contracts/:id/cancel', (req, res) => {
  try {
