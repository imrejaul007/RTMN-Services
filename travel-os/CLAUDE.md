# Travel OS - Development Guide

**Port:** 5190  
**Type:** Industry OS (travel)  
**Industry:** Travel
...
|----------|-------------|----------|
| PORT | Service port | No (default: 5190) |
...
Travel OS manages complete travel operations.
...
curl -X POST http://localhost:5190/auth/register \
  ...
  -d '{"businessId":"biz_123","email":"owner@travel.com","password":"secret"}'

# Login
curl -X POST http://localhost:5190/auth/login \
  -H "Content-Type: application/json" \
  -d '{"email":"owner@travel.com","password":"secret"}'
```
