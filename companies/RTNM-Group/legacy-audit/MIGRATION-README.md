# RTNM-Group Legacy Audit Archive

> **Date moved:** 2026-06-22
> **Source:** `/Users/rejaulkarim/Documents/RTMN/companies/REZ-Workspace/companies/RTNM-Group/`
> **Original size:** 30M (47 dirs)

## What's in here

This directory contains the original RTNM-Group codebase from the nested `REZ-Workspace/companies/` location, **before** it was consolidated into the current top-level structure.
...
Top-level has 18 high-level dirs. Nested had 47 dirs with REZ-*, rez-*, rtnm-* services. All preserved as legacy.
...
- The current production code (lives at `/Users/rejaulkarim/Documents/RTMN/companies/RTNM-Group/`)
