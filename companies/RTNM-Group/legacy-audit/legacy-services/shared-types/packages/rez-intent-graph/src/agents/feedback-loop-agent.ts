...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([FeedbackLoopAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[FeedbackLoopAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([FeedbackLoopAgent] ${msg}`, meta || ''),
