...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([DemandSignalAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[DemandSignalAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([DemandSignalAgent] ${msg}`, meta || ''),
};
