...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([NetworkEffectAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[NetworkEffectAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([NetworkEffectAgent] ${msg}`, meta || ''),
};
