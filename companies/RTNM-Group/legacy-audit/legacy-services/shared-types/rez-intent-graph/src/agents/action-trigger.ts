...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([ActionTrigger] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[ActionTrigger] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([ActionTrigger] ${msg}`, meta || ''),
};
