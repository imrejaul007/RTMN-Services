...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([AdaptiveScoringAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[AdaptiveScoringAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([AdaptiveScoringAgent] ${msg}`, meta || ''),
};
