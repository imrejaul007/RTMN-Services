...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([ScarcityAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[ScarcityAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([ScarcityAgent] ${msg}`, meta || ''),
};
