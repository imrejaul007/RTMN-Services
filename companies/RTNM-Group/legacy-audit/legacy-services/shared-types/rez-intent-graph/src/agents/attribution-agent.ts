...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([AttributionAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[AttributionAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([AttributionAgent] ${msg}`, meta || ''),
};
