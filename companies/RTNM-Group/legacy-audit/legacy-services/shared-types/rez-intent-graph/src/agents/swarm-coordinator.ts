...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([SwarmCoordinator] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[SwarmCoordinator] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([SwarmCoordinator] ${msg}`, meta || ''),
};
