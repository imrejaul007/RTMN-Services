...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([PersonalizationAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[PersonalizationAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([PersonalizationAgent] ${msg}`, meta || ''),
};
