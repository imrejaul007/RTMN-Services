...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([RevenueAgent] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[RevenueAgent] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([RevenueAgent] ${msg}`, meta || ''),
};
