...
const logger = {
  info: (msg: string, meta?: Record<string, unknown>) => logger.info([ExternalServices] ${msg}`, meta || ''),
  warn: (msg: string, meta?: Record<string, unknown>) => console.warn(`[ExternalServices] ${msg}`, meta || ''),
  error: (msg: string, meta?: Record<string, unknown>) => logger.error([ExternalServices] ${msg}`, meta || ''),
};
