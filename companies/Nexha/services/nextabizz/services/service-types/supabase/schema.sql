-- ============================================
-- NextaBizz: Service Categories Schema
-- ============================================
-- Version: 001
-- Description: Service categories, vendors, RFQs, and quotes
-- ============================================
...
-- ============================================
-- Seed Data: 12 Service Categories
-- ============================================
...
-- Tier 2: Subcategories for Catering Services
...
-- Tier 2: Subcategories for Maintenance & Repair
...
-- Tier 2: Subcategories for Cleaning Services
...
-- Tier 2: Subcategories for Security Services
...
-- Tier 2: Subcategories for Transportation & Logistics
...
-- Tier 2: Subcategories for Events & Entertainment
...
-- Tier 2: Subcategories for Technology Services
...
-- Tier 2: Subcategories for Consulting & Professional
...
BEGIN
    ...
    RAISE NOTICE '=== Service Categories Seed Verification ===';
...
-- Final status
SELECT 'Service categories schema created: 4 tables, indexes, triggers, RLS policies, and 12+ categories seeded' AS status;
