...
import { createDhlHandler, createFedexHandler, createMaerskHandler, createUniversalHandler, getRecentEvents, getShipmentByTrackingNumber } from './tracking/webhooks.js';
...
app.post('/api/v1/shipments/estimate', requireAuth, async (req, res) => {
    try {
        const schema = z.object({
            origin: AddressSchema,
            destination: AddressSchema,
        ...
        const request = {
            ...
            cargo: {
                type: params.cargo.type || 'general',
...
app.post('/api/v1/shipments/:id/document', requireAuth, (req, res) => {
    try {
        const schema = z.object({
