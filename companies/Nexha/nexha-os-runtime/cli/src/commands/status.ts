...
const SERVICES = [
  ...
  { name: 'nexha-catalog-os', port: 4370, path: '/health' },
  { name: 'nexha-order-os', port: 4371, path: '/health' },
  { name: 'nexha-agent-os', port: 4372, path: '/health' },
  { name: 'nexha-supplier-os', port: 4373, path: '/health' },
