/**
 * sutar-trade-finance — Express server (port 4287).
 *
...
app.get('/health', (_req, res) => {
  res.json({ status: 'healthy', service: 'sutar-trade-finance', port: PORT });
});
...
app.listen(PORT, () => {
  console.log(`sutar-trade-finance running on port ${PORT}`);
