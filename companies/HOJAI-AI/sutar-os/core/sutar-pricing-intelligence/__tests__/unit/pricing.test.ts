/**
 * sutar-pricing-intelligence — unit tests
 *
...
describe('sutar-pricing-intelligence — product registry', () => {
...
describe('sutar-pricing-intelligence — price point recording', () => {
  beforeEach(() => svc._resetForTests());
...
describe('sutar-pricing-intelligence — price comparison', () => {
  beforeEach(() => svc._resetForTests());
...
describe('sutar-pricing-intelligence — alerts', () => {
  beforeEach(() => svc._resetForTests());
...
describe('sutar-pricing-intelligence — dynamic pricing', () => {
  beforeEach(() => svc._resetForTests());
...
describe('sutar-pricing-intelligence — network stats', () => {
  beforeEach(() => svc._resetForTests());
