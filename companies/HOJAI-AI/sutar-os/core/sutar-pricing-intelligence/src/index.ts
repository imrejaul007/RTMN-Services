...
app.get('/health', (_req, res) => {
  res.json({ status: 'healthy', service: 'sutar-pricing-intelligence', port: PORT });
});
...
app.get('/api/v1/info', (_req, res) => {
  res.json({
    service: 'sutar-pricing-intelligence',
    version: '1.0.0',
    description:
...
app.listen(PORT, () => {
  console.log(`sutar-pricing-intelligence running on port ${PORT}`);
