...
if (REQUIRE_AUTH) {
  try {
    ...
    console.warn('[sutar-logistics] @rtmn/shared/auth not available — auth disabled');
  }
}
...
const server = app.listen(PORT, () => {
  console.log(`sutar-logistics running on port ${PORT}`);
});
