/**
 * Tests for sutar-tenant-instances' rez-intel-client.js (dual-client, ESM)
 *
 * sutar-tenant-instances is an ESM service ("type": "module"). We use dynamic
 * `import()` with a cache-buster query string so each test gets a fresh module
 * instance (since ESM modules cache aggressively and we need to flip INTEL_MODE).
 *
