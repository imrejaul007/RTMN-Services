/**
 * Internal utilities for HOJAI Reputation SDK (shared pattern across @hojai/*)
 *
 * Provides:
...
export async function request<T = unknown>(
  ...
  const url = new URL(path, config.baseUrl || DEFAULT_BASE_URL).toString();
...
const DEFAULT_BASE_URL = 'https://api.hojai.ai';