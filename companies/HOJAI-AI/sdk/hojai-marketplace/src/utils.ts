/**
 * Internal utilities for HOJAI Marketplace SDK
 *
 * Copied verbatim from @hojai/sutar so this SDK is installable on its own.
 */
...
/**
 * Build just the query-string suffix (e.g. "?foo=1&bar=2") from an object.
 * Skips undefined / null / empty values. Used for GET requests where the
 * SDK caller passes an object instead of a hand-built query string.
 *
 * Returns '' if nothing to append.
 */
