/**
 * Internal utilities for HOJAI Department SDK
 *
 * Copied verbatim from the @hojai/* SDK family so this SDK is
...
/** Build the query-string suffix (e.g. "?foo=1&bar=2") for GET requests. */
