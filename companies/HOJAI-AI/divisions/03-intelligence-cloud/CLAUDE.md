...
├── Airzy Intelligence
└── Karma Intelligence
# (RisaCare Intelligence removed — RisaCare is an external client and consumes
#  the generic services/healthcare-vertical-intelligence on port 4160 instead.)
```
...
| RisaCare Intelligence | ❌ **External client** — RisaCare is no longer an internal RTMN platform. RisaCare consumes the **generic** `services/healthcare-vertical-intelligence` (port 4160) instead. |
...
| # | Item | Status | Notes |
|---|---|---|---|
| 1 | Replace thin `ai-intelligence` (4881) with recovered HOJAI Intelligence | ✅ **DONE** | Running v1.0 |
| 2 | Replace thin `customer-intelligence` (4885) with recovered version | ✅ **DONE** | Running v2.0 CDP |
| 3 | Predictive Intelligence | ✅ **DONE** | `services/predictive-intelligence` (4754) |
| 4 | Risk Intelligence | ✅ **DONE** | `services/risk-intelligence` (4755) |
| 5 | Decision Intelligence | ✅ **DONE** | `services/decision-intelligence` (4756) |
| 6 | Micro Intelligence | ✅ **DONE** | `services/micro-intelligence` (4753) |
| 7 | Fix sales-intelligence endpoint bugs | ✅ **DONE** | |
| 8 | Consolidate 11 AdBazaar REZ Atlas intelligence services | ⚪ **DEPRECATED** | Accepted as-is; layering documented in AdBazaar CLAUDE.md |
| 9 | Promote AdBazaar scaffolds to real implementations (4) | ⚪ **EXTERNAL** | Owned by AdBazaar team, not part of HOJAI AI |
| 10 | Promote Axom BuzzLocal scaffolds (3) | ⚪ **EXTERNAL** | Owned by Axom team |
| 11 | Promote RABTUL REZ-* scaffolds (5) | ⚪ **EXTERNAL** | Owned by RABTUL team |
| 12 | **Behavior Intelligence** | ✅ **DONE** | `services/behavior-intelligence` (4158) — segments, intents, profiles |
| 13 | Promote CorpPerks intelligence | ⚪ **EXTERNAL** | Owned by CorpPerks |
| 14 | Build 5 standalone Company Intelligences (Nexha, RisaCare, Rendez, Airzy, Karma) | ✅ **PARTIAL** | 4159 (Nexha) ✅; **4160 repurposed as generic `healthcare-vertical-intelligence`** (consumed by RisaCare as external client); 4161 (Rendez), 4162 (Airzy), 4163 (Karma) ❌ not built |
| 15 | Build standalone Industry Intelligence modules | 🟡 **DEFERRED** | Debatable per Open Questions; current Industry OS has built-in intelligence |
...
**Services in this division:** AI Intelligence (4881), Reasoning Runtime, RAG Platform, Vector DB, Graph Database, Knowledge Extraction, Inference Gateway, GraphQL Federation, Semantic Cache, Micro Intelligence, Knowledge Marketplace
