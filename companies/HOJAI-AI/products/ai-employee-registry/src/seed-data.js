...
const SEED_EMPLOYEES = [
  ...
  },
  {
    ...
    serviceUrl: `${BASE}:4740`,
    port: 4740,
    version: '1.0.0',
    pricing: { model: 'usage', perCall: 0.5 },
    rating: { score: 4.5, reviews: 234 },
    installs: 890,
    status: 'available',
    visionAgent: true,
    visionRole: 'research',
    notes: 'genie-research at port 4740 — web search, PDF parsing, citation tracking, LLM synthesis'
  },
  {
    id: 'emp_creator',
    slug: 'genie-creator',
  ...
  },
  {
    ...
    serviceUrl: `${BASE}:4714`,
    port: 4714,
    version: '1.0.0',
    pricing: { model: 'usage', perBooking: 5 },
    rating: { score: 4.3, reviews: 156 },
    installs: 780,
    status: 'available',
    visionAgent: true,
    visionRole: 'travel',
    notes: 'genie-travel-agent at port 4714 — flight search, hotel booking, itinerary planning, Nexha logistics wiring'
  },
  {
    id: 'emp_shopping',
    slug: 'genie-shopping',
