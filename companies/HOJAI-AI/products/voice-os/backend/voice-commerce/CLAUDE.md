# CLAUDE.md - Hojai Voice Commerce

## Project Overview

**Name:** Hojai Voice Commerce
**Type:** Voice AI
**Purpose:** Hojai Voice Commerce - Transactional Voice AI
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4880) |
...
| GET | /api/orders/:id | GET request |
| GET | /api/orders/customer/:customerId | GET request |
| GET | /api/bookings/:id | GET request |
| GET | /api/bookings/customer/:customerId | GET request |
| GET | /api/bookings/availability | GET request |
| GET | /api/analytics | GET request |
| POST | /api/session/start | POST request |
| POST | /api/voice/command | POST request |
| POST | /api/session/end | POST request |
| POST | /api/orders/:id/pay | POST request |
