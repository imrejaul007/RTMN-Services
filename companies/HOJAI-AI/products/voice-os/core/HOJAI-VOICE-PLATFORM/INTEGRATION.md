# Hojai Voice Platform - Integration Guide

## Overview

This document describes how to integrate with Hojai Voice Platform.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-voice-platform
