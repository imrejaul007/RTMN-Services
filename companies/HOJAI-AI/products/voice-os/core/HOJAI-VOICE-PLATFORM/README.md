...
> **Voice AI** | HOJAI Voice Platform - Enterprise Voice AI for customer interactions

---

## Overview

This is a voice ai service in the HOJAI AI ecosystem.
...
**Response:**
```json
{"status": "healthy", "service": "hojai-voice-platform", "timestamp": "..."}
```
...
```bash
docker build -t hojai-voice-platform:latest .
docker run -p 3000:3000 hojai-voice-platform:latest
```
