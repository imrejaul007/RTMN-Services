#!/bin/bash
# business-copilot - Auto-generated smoke tests
set -u
...
run() {
  ...
  local body_file="${TMPDIR}/_business_copilot_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  business-copilot - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/industries" GET "/api/industries" "" "" "200"
run "auto GET /api/skills/search" GET "/api/skills/search" "" "" "200"
run "auto POST /api/chat" POST "/api/chat" '{"test":true}' "" "201"
run "auto POST /api/skills/execute" POST "/api/skills/execute" '{"test":true}' "" "201"
