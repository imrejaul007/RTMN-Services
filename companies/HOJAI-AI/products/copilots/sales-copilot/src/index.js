...
const suggestions = new PersistentMap('suggestions', { serviceName: 'sales-copilot' });
const templates = new PersistentMap('templates', { serviceName: 'sales-copilot' });
const competitors = new PersistentMap('competitors', { serviceName: 'sales-copilot' });
...
app.post('/api/prioritize',requireAuth,  (req, res) => {
...
app.post('/api/talking-points',requireAuth,  (req, res) => {
...
app.post('/api/email/generate',requireAuth,  (req, res) => {
...
app.post('/api/meeting/prepare',requireAuth,  (req, res) => {
