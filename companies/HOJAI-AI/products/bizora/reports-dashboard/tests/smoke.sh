#!/bin/bash
# reports-dashboard - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4874}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_reports_dashboard_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  reports-dashboard - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/dashboards" GET "/api/dashboards" "" "" "200"
run "auto GET /api/dashboards/test-id" GET "/api/dashboards/test-id" "" "" "200"
run "auto GET /api/widgets" GET "/api/widgets" "" "" "200"
run "auto GET /api/widgets/test-id/data" GET "/api/widgets/test-id/data" "" "" "200"
run "auto GET /api/reports" GET "/api/reports" "" "" "200"
run "auto POST /api/reports/generate" POST "/api/reports/generate" '{"test":true}' "" "201"
run "auto GET /api/reports/test-id" GET "/api/reports/test-id" "" "" "200"
run "auto GET /api/reports/test-id/download" GET "/api/reports/test-id/download" "" "" "200"
run "auto GET /api/scheduled" GET "/api/scheduled" "" "" "200"
run "auto POST /api/export" POST "/api/export" '{"test":true}' "" "201"
run "auto GET /api/export/test-id" GET "/api/export/test-id" "" "" "200"
