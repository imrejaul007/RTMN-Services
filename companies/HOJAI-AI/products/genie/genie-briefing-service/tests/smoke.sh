#!/bin/bash
# genie-briefing-service - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4777}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_genie_briefing_service_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  genie-briefing-service - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/briefing/morning" GET "/api/briefing/morning" "" "" "200"
run "auto GET /api/briefing/evening" GET "/api/briefing/evening" "" "" "200"
run "auto GET /api/briefing/weekly" GET "/api/briefing/weekly" "" "" "200"
run "auto GET /api/briefing/today" GET "/api/briefing/today" "" "" "200"
run "auto GET /api/briefing/test-id" GET "/api/briefing/test-id" "" "" "200"
run "auto GET /api/briefing/history" GET "/api/briefing/history" "" "" "200"
run "auto POST /api/subscribe" POST "/api/subscribe" '{"test":true}' "" "201"
run "auto GET /api/subscriptions" GET "/api/subscriptions" "" "" "200"
run "auto DELETE /api/subscribe/test-id" DELETE "/api/subscribe/test-id" "" "" "200"
