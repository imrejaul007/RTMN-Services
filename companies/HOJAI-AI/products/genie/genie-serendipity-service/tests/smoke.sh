#!/bin/bash
# genie-serendipity-service - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4382}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_genie_serendipity_service_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  genie-serendipity-service - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/serendipity" GET "/api/serendipity" "" "" "200"
run "auto GET /api/serendipity/time" GET "/api/serendipity/time" "" "" "200"
run "auto GET /api/serendipity/context" GET "/api/serendipity/context" "" "" "200"
run "auto GET /api/serendipity/people" GET "/api/serendipity/people" "" "" "200"
run "auto GET /api/serendipity/daily" GET "/api/serendipity/daily" "" "" "200"
run "auto POST /api/serendipity/test-id/feedb" POST "/api/serendipity/test-id/feedback" '{"test":true}' "" "201"
run "auto GET /api/serendipity/history" GET "/api/serendipity/history" "" "" "200"
run "auto POST /api/subscribe" POST "/api/subscribe" '{"test":true}' "" "201"
