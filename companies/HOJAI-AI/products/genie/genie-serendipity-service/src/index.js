...
// In-memory stores
const memories = new PersistentMap('memories', { serviceName: 'genie-serendipity-service' });
const resurfacedItems = new PersistentMap('resurfaced-items', { serviceName: 'genie-serendipity-service' });
const subscriptions = new PersistentMap('subscriptions', { serviceName: 'genie-serendipity-service' });
 ...
 */
app.post('/api/serendipity/:id/feedback',requireAuth,  (req, res) => {
