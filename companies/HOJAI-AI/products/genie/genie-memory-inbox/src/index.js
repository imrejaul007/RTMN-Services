...
const PORT = process.env.GENIE_INBOX_PORT || 4736;
...
const memories = new PersistentMap('memories', { serviceName: 'genie-memory-inbox' });
const tags = new PersistentMap('tags', { serviceName: 'genie-memory-inbox' });
const categories = new PersistentMap('categories', { serviceName: 'genie-memory-inbox' });
const reminders = new PersistentMap('reminders', { serviceName: 'genie-memory-inbox' });
