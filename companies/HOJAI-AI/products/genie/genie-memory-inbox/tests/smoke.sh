#!/bin/bash
# genie-memory-inbox - Auto-generated smoke tests
set -u
...
run() {
  ...
  local body_file="${TMPDIR}/_genie_memory_inbox_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  genie-memory-inbox - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/categories" GET "/api/categories" "" "" "200"
run "auto DELETE /api/categories/test-id" DELETE "/api/categories/test-id" "" "" "200"
run "auto GET /api/tags" GET "/api/tags" "" "" "200"
run "auto GET /api/stats" GET "/api/stats" "" "" "200"
run "auto GET /api/reminders" GET "/api/reminders" "" "" "200"
run "auto PATCH /api/reminders/test-id" PATCH "/api/reminders/test-id" '{"test":true}' "" "200"
