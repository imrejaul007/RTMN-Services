#!/bin/bash
# genie-universal-search - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4532}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_genie_universal_search_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  genie-universal-search - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/search" GET "/api/search" "" "" "200"
run "auto GET /api/search/semantic" GET "/api/search/semantic" "" "" "200"
run "auto GET /api/search/memories" GET "/api/search/memories" "" "" "200"
run "auto GET /api/search/twins" GET "/api/search/twins" "" "" "200"
run "auto GET /api/search/people" GET "/api/search/people" "" "" "200"
run "auto GET /api/search/health" GET "/api/search/health" "" "" "200"
run "auto GET /api/search/finance" GET "/api/search/finance" "" "" "200"
run "auto GET /api/search/calendar" GET "/api/search/calendar" "" "" "200"
run "auto GET /api/search/tasks" GET "/api/search/tasks" "" "" "200"
run "auto POST /api/search/saved" POST "/api/search/saved" '{"test":true}' "" "201"
run "auto DELETE /api/search/saved/test-id" DELETE "/api/search/saved/test-id" "" "" "200"
