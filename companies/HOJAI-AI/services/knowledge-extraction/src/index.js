...
const kbEntities = new Map();

// Index by lowercase canonical + aliases for fast lookup
const kbIndex = new Map(); // key: `${type}:${lower}` -> id
...
app.post('/api/kb/entities', (req, res) => {
...
app.delete('/api/kb/entities/:id', (req, res) => {
...
app.post('/api/facts/extract', (req, res) => {
  const startMs = Date.now();
