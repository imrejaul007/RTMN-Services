 ...
 * POST /api/partners
 */
app.post('/api/partners', strictLimiter, (req, res, next) => {
  try {
 ...
 * PUT /api/partners/:id
 */
app.put('/api/partners/:id', strictLimiter, (req, res, next) => {
  try {
    const { id } = req.params;
    ...
    partners.set(id, updatedPartner);
 ...
 */
app.delete('/api/partners/:id', strictLimiter, (req, res, next) => {
  try {
    const { id } = req.params;
 ...
 */
app.post('/api/partners/:id/relationships', strictLimiter, (req, res, next) => {
  try {
    const { id } = req.params;
    const partner = partners.get(id);
    ...
    relationships.get(id).push(relationship);
