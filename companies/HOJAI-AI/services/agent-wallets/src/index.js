 ...
 */
app.post('/api/wallets/:id/pay', (req, res) => {
  try {
 ...
 */
app.post('/api/wallets/:id/escrow', (req, res) => {
  try {
 ...
 */
app.post('/api/escrow/:escrowId/refund', (req, res) => {
  try {
 ...
 */
app.post('/api/wallets/:id/freeze', (req, res) => {
  try {
    const { reason } = req.body;
