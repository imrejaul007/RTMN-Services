...
const permissionStorage = new Map();
const securityLogStorage = new Map();
...
// List users
app.get('/api/twins/users', defaultLimiter, asyncHandler(async (req, res) => {
...
// Create user
app.post('/api/twins/users', defaultLimiter, asyncHandler(async (req, res) => {
...
// Create session
app.post('/api/twins/sessions', defaultLimiter, asyncHandler(async (req, res) => {
