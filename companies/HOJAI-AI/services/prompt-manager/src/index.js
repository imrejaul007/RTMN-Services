 ...
 */
app.patch('/api/templates/:idOrSlug', (req, res) => {
  const t = findTemplate(req.params.idOrSlug);
  if (!t) return res.status(404).json({ error: 'Template not found' });
 ...
 */
app.delete('/api/templates/:idOrSlug', (req, res) => {
  const t = findTemplate(req.params.idOrSlug);
  if (!t) return res.status(404).json({ error: 'Template not found' });
 ...
 */
app.post('/api/templates/:idOrSlug/versions', (req, res) => {
  const t = findTemplate(req.params.idOrSlug);
  if (!t) return res.status(404).json({ error: 'Template not found' });
 ...
 * Body: { version }
 */
app.post('/api/templates/:idOrSlug/rollback', (req, res) => {
  const t = findTemplate(req.params.idOrSlug);
  if (!t) return res.status(404).json({ error: 'Template not found' });
 ...
 */
app.post('/api/templates/:idOrSlug/render', (req, res) => {
  const t = findTemplate(req.params.idOrSlug);
  if (!t) return res.status(404).json({ error: 'Template not found' });
