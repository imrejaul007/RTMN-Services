...
{{PROJECT_TITLE}} is a **POS** built with the HOJAI Foundry `pos` starter.
Point-of-Sale: counter, barcode, receipts, daily reconciliation.

Region: **{{REGION}}** · Languages: **{{LANGUAGES_COMMA}}** · Template: **pos**
...
| Endpoint | Purpose |
|---|---|
| `/api/product` | product endpoints |
| `/api/sale` | sale endpoints |
