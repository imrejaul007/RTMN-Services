...
function MarketingStrategy(body = {}) {
  return { agent: "Marketing", received: body, message: 'Stub response (no LLM in v0). Replace the strategy with a real @hojai/sutar BaseAgent or LLM call.' };
}
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Orchestrator. Strategic decision support, KPI tracking.",
  capabilities: [],
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Sales coaching, deal inspection, forecast.",
  capabilities: [],
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Campaign planning, audience insights.",
  capabilities: [],
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Hiring screen, leave approval, performance reviews.",
  capabilities: [],
  strategy: HRStrategy
}));
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Budget alerts, expense policy, financial summaries.",
  capabilities: [],
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Process bottlenecks, resource allocation.",
  capabilities: [],
