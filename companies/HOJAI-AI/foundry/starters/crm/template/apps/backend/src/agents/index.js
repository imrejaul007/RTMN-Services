...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Orchestrator. Pipeline coverage, win rate.",
  capabilities: [],
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Lead scoring, next-best-action, follow-up drafting.",
  capabilities: [],
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Customer health, ticket triage, renewal alerts.",
  capabilities: [],
...
registry.register(new BaseAgent({
  ...
  type: 'merchant',
  industry: 'unknown',
  description: "Lead source attribution, campaign → revenue.",
  capabilities: [],
