...
> **HOJAI Core** | HOJAI Continuous Learning / Training Pipeline - Learn from conversations, actions, corrections, and feedback
...
**Response:**
```json
{"status": "healthy", "service": "hojai-training-pipeline", "timestamp": "..."}
```
