# CLAUDE.md - Hojai Training Pipeline

## Project Overview

**Name:** Hojai Training Pipeline
**Type:** HOJAI Core
**Purpose:** HOJAI Continuous Learning / Training Pipeline - Learn from conversations, actions, corrections, and feedback
