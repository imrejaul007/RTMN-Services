# Finance Collections - Integration Guide

## Overview

This document describes how to integrate with Finance Collections.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/finance-collections
