...
> **HOJAI Core** | HOJAI Marketing Intelligence - Marketing AI for Businesses
...
**Response:**
```json
{"status": "healthy", "service": "hojai-marketing-intelligence", "timestamp": "..."}
```
