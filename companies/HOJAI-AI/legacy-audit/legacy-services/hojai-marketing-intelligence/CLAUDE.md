# CLAUDE.md - Hojai Marketing Intelligence

## Project Overview

**Name:** Hojai Marketing Intelligence
**Type:** HOJAI Core
**Purpose:** HOJAI Marketing Intelligence - Marketing AI for Businesses
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4753) |
...
{
  "status": "healthy",
  "service": "hojai-marketing-intelligence",
  "version": "1.0.0"
}
```
