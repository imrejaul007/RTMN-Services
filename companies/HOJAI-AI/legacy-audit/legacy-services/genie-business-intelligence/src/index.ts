/**
 * GENIE Business Intelligence Service - Main Entry Point
...
const SERVICE_NAME = 'genie-business-intelligence';
...
app.use(cors({
  ...
  allowedHeaders: ['Content-Type', 'Authorization', 'X-Tenant-Id', 'X-Merchant-Id', 'X-Request-Id'],
}));
...
╔══════════════════════════════════════════════════════════════╗
║                                                              ║
║   GENIE Business Intelligence Service                        ║
