/**
 * HOJAI Engineering Incident Response Commander
 * Port: 4916
 *
 * AI-powered incident-response-commander for engineering operations
 */
...
const SERVICE_NAME = 'incident-response-commander';
