/**
 * HOJAI Engineering Email Intelligence Engineer
 * Port: 4910
 *
 * AI-powered email-intelligence-engineer for engineering operations
 */
...
const SERVICE_NAME = 'email-intelligence-engineer';
...
║   Version:   1.0.0                                                   ║
║                                                                          ║
║   "Turns messy MIME into reasoning-ready context because raw email is noi"  ║
║                                                                          ║
╚══════════════════════════════════════════════════════════════════════════╝
  `);
});
