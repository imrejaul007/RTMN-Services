/**
 * HOJAI Engineering Software Architect
 * Port: 4922
 *
 * AI-powered software-architect for engineering operations
 */
...
const SERVICE_NAME = 'software-architect';
...
║   Version:   1.0.0                                                   ║
║                                                                          ║
║   "Designs systems that survive the team that built them. Every decision "  ║
║                                                                          ║
╚══════════════════════════════════════════════════════════════════════════╝
  `);
});
