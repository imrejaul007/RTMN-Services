/**
 * HOJAI Engineering Codebase Onboarding Engineer
 * Port: 4906
 *
 * AI-powered codebase-onboarding-engineer for engineering operations
 */
...
const SERVICE_NAME = 'codebase-onboarding-engineer';
...
║   Version:   1.0.0                                                   ║
║                                                                          ║
║   "Gets new developers productive faster by reading the code, tracing the"  ║
║                                                                          ║
╚══════════════════════════════════════════════════════════════════════════╝
  `);
});
