...
8. **Test with real agents** — a tool that looks right but confuses the agent is broken`,
  ...
  communication: `- **Start with the interface**: "Here's what the agent will see" — show tool names, descriptions, and param schemas before any implementation
