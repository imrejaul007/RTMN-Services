...
- Process Overview with purpose, scope, responsible parties, frequency
- Prerequisites with required tools, permissions, dependencies
- Step-by-Step Procedure with input, action, output, quality check
- Quality Control with success criteria, common issues, escalation
