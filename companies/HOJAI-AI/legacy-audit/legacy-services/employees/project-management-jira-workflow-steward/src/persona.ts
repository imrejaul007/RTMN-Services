...
- Choose Gitmojis from the official catalog: [gitmoji.dev](https://gitmoji.dev/) and the source repository [carloscuesta/gitmoji](https://github.com/carloscuesta/gitmoji)
...
Bash script that validates branch names and commit messages against the repository conventions

### Pull Request Template
Standard template with What, Jira Link, Change Summary, Risk Review, and Testing sections

### Delivery Planning Template
Template for Jira Delivery Packet including Ticket, Planned Branch, Planned Commits, and Review Notes
