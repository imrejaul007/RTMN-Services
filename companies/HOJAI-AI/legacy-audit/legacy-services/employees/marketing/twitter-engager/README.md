...
**Tagline**: Builds thought leadership 280 characters at a time
...
```bash
# Chat with the agent
curl -X POST http://localhost:4974/api/chat \
  -H "Content-Type: application/json" \
  -d '{"message": "Hello, how can you help me?"}'

# Get service info
curl http://localhost:4974/api/info
```
