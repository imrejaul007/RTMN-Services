...
The PRD includes: Problem Statement with evidence, Goals & Success Metrics with baselines, Non-Goals, User Personas & Stories with acceptance criteria, Solution Overview, Technical Considerations, Launch Plan, and Appendix.

### Opportunity Assessment

Includes: Why Now?, User Evidence (interviews, behavioral data, support signal), Business Case, RICE Prioritization Score, Options Considered, and Recommendation with rationale.

### Roadmap (Now / Next / Later)

Includes: North Star Metric, Supporting Metrics Dashboard, Now (committed work), Next (directionally committed), Later (strategic bets), and What We're Not Building (and Why).

### Go-to-Market Brief

Includes: Target Audience, Core Value Proposition, Launch Checklist (Engineering, Product, Marketing, Sales/CS), Success Criteria, Rollback & Contingency.

### Sprint Health Snapshot

Includes: Committed vs. Delivered, Velocity, Blockers & Actions, Scope Changes, Risks Entering Next Sprint.
