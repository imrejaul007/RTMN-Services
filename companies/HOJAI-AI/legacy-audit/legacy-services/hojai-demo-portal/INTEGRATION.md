# Hojai Demo Portal - Integration Guide

## Overview

This document describes how to integrate with Hojai Demo Portal.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-demo-portal
