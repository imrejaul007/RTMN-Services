# Pharmacy Ai - Integration Guide

## Overview

This document describes how to integrate with Pharmacy Ai.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/pharmacy-ai
...
```javascript
// GET request
const data = await fetch('http://localhost:4810/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4810/api/v1/resource', {
  method: 'POST',
  headers,
