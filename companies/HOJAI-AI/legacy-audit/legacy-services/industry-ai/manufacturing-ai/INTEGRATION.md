# Manufacturing Ai - Integration Guide

## Overview

This document describes how to integrate with Manufacturing Ai.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/manufacturing-ai
