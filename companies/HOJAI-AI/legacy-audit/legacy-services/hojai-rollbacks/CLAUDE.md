# CLAUDE.md - Hojai Rollbacks

## Project Overview

**Name:** Hojai Rollbacks
**Type:** HOJAI Core
**Purpose:** HOJAI Rollbacks - One-click rollback to previous version
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4594) |
...
| GET | /api/deployments | GET request |
| GET | /api/deployments/active/:agentId | GET request |
| GET | /api/rollback-points/:agentId | GET request |
| GET | /api/rollback/:id | GET request |
| GET | /api/rollback | GET request |
| POST | /api/rollback-points | POST request |
| POST | /api/rollback | POST request |
| POST | /api/rollback/:id/approve | POST request |
| POST | /api/rollback/:agentId/quick | POST request |
