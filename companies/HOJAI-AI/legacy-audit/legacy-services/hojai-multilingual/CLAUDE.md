# CLAUDE.md - Hojai Multilingual

## Project Overview

**Name:** Hojai Multilingual
**Type:** HOJAI Core
**Purpose:** Hojai Multilingual - 10 Indian Languages
...
| GET | /api/languages | GET request |
| POST | /api/detect | POST request |
| POST | /api/translate/template | POST request |
| POST | /api/translate | POST request |
| POST | /api/stt/multilingual | POST request |
