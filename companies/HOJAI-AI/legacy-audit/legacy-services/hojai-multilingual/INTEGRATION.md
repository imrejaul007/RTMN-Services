# Hojai Multilingual - Integration Guide

## Overview

This document describes how to integrate with Hojai Multilingual.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-multilingual
