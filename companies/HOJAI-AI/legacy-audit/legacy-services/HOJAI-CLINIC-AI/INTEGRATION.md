# Hojai Clinic Ai - Integration Guide

## Overview

This document describes how to integrate with Hojai Clinic Ai.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-clinic-ai
