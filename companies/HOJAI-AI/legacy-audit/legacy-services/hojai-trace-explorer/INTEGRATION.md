# Hojai Trace Explorer - Integration Guide

## Overview

This document describes how to integrate with Hojai Trace Explorer.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-trace-explorer
...
```javascript
// GET request
const data = await fetch('http://localhost:4596/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4596/api/v1/resource', {
  method: 'POST',
  headers,
