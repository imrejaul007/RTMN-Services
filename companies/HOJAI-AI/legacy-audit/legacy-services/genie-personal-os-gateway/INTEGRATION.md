# Genie Personal Os Gateway - Integration Guide

## Overview

This document describes how to integrate with Genie Personal Os Gateway.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-personal-os-gateway
