# Genie Obsidian Service - Integration Guide

## Overview

This document describes how to integrate with Genie Obsidian Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-obsidian-service
