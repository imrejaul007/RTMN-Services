# Genie Drive Connector - Integration Guide

## Overview

This document describes how to integrate with Genie Drive Connector.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-drive-connector
