# Sutar Rez Bridge - Integration Guide

## Overview

This document describes how to integrate with Sutar Rez Bridge.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/sutar-rez-bridge
