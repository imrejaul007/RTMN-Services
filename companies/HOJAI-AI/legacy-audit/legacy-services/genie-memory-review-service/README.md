...
This is the Genie memory review-service service for HOJAI Genie AI.
...
```bash
docker build -t genie-memory-review-service .
docker run -p 3000:3000 genie-memory-review-service
```
