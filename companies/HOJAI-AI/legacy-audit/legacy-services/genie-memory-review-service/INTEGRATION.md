# Genie Memory Review Service - Integration Guide

## Overview

This document describes how to integrate with Genie Memory Review Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-memory-review-service
