# Rez Autonomous Growth Agent - Integration Guide

## Overview

This document describes how to integrate with Rez Autonomous Growth Agent.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-autonomous-growth-agent
