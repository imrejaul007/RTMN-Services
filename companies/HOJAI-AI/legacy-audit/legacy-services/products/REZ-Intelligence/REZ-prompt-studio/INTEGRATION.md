# Rez Prompt Studio - Integration Guide

## Overview

This document describes how to integrate with Rez Prompt Studio.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-prompt-studio
