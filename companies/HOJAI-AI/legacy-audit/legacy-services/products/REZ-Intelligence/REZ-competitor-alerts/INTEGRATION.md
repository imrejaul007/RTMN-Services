# Rez Competitor Alerts - Integration Guide

## Overview

This document describes how to integrate with Rez Competitor Alerts.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-competitor-alerts
