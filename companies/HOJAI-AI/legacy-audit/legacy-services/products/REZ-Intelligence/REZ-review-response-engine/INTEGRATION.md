# Rez Review Response Engine - Integration Guide

## Overview

This document describes how to integrate with Rez Review Response Engine.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-review-response-engine
