# Rez Budget Optimizer - Integration Guide

## Overview

This document describes how to integrate with Rez Budget Optimizer.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-budget-optimizer
