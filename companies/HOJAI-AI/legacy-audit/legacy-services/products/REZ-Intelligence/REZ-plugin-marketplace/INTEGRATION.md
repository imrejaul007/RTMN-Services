# Rez Plugin Marketplace - Integration Guide

## Overview

This document describes how to integrate with Rez Plugin Marketplace.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-plugin-marketplace
