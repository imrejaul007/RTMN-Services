# Rez Predictive Engine - Integration Guide

## Overview

This document describes how to integrate with Rez Predictive Engine.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-predictive-engine
