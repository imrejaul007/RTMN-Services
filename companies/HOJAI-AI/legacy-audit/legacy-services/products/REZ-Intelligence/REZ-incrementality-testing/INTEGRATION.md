# Rez Incrementality Testing - Integration Guide

## Overview

This document describes how to integrate with Rez Incrementality Testing.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-incrementality-testing
