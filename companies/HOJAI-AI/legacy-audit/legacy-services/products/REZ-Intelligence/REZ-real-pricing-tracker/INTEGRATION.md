# Rez Real Pricing Tracker - Integration Guide

## Overview

This document describes how to integrate with Rez Real Pricing Tracker.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-real-pricing-tracker
