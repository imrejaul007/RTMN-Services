# Rez Growth Dashboard - Integration Guide

## Overview

This document describes how to integrate with Rez Growth Dashboard.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-growth-dashboard
