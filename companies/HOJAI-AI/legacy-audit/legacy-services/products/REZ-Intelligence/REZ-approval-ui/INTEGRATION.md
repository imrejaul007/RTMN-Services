# Rez Approval Ui - Integration Guide

## Overview

This document describes how to integrate with Rez Approval Ui.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-approval-ui
