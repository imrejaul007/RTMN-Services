# Rez Supply Intelligence - Integration Guide

## Overview

This document describes how to integrate with Rez Supply Intelligence.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-supply-intelligence
