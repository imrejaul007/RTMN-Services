# Rez Memory Layer - Integration Guide

## Overview

This document describes how to integrate with Rez Memory Layer.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-memory-layer
