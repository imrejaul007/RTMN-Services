# Rez Intent Predictor - Integration Guide

## Overview

This document describes how to integrate with Rez Intent Predictor.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-intent-predictor
