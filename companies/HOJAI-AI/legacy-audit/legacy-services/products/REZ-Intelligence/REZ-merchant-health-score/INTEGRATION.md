# Rez Merchant Health Score - Integration Guide

## Overview

This document describes how to integrate with Rez Merchant Health Score.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-merchant-health-score
