# Rez Visual Workflow Builder Ui - Integration Guide

## Overview

This document describes how to integrate with Rez Visual Workflow Builder Ui.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-visual-workflow-builder-ui
...
```javascript
// GET request
const data = await fetch('http://localhost:3000/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:3000/api/v1/resource', {
  method: 'POST',
  headers,
