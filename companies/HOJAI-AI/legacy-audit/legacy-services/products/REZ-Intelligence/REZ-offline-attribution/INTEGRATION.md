# Rez Offline Attribution - Integration Guide

## Overview

This document describes how to integrate with Rez Offline Attribution.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-offline-attribution
