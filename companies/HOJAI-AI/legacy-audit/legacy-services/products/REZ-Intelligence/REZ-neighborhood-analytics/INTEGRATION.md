# Rez Neighborhood Analytics - Integration Guide

## Overview

This document describes how to integrate with Rez Neighborhood Analytics.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-neighborhood-analytics
