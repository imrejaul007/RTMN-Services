# Rez Growth Playbook - Integration Guide

## Overview

This document describes how to integrate with Rez Growth Playbook.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-growth-playbook
