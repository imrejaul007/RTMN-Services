# Rez Financial Graph - Integration Guide

## Overview

This document describes how to integrate with Rez Financial Graph.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-financial-graph
