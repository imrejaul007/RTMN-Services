# Rez Unified Offer Brain - Integration Guide

## Overview

This document describes how to integrate with Rez Unified Offer Brain.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-unified-offer-brain
