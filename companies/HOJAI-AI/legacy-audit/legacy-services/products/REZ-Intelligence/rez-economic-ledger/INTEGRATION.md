# Rez Economic Ledger - Integration Guide

## Overview

This document describes how to integrate with Rez Economic Ledger.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-economic-ledger
