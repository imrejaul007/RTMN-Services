# Rez Demand Sensing - Integration Guide

## Overview

This document describes how to integrate with Rez Demand Sensing.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-demand-sensing
