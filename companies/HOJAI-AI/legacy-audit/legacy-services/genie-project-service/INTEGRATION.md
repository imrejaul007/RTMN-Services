# Genie Project Service - Integration Guide

## Overview

This document describes how to integrate with Genie Project Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-project-service
