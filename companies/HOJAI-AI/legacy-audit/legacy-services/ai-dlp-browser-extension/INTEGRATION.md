# Ai Dlp Browser Extension - Integration Guide

## Overview

This document describes how to integrate with Ai Dlp Browser Extension.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/ai-dlp-browser-extension
