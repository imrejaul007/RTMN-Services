# Hojai Skills Routing - Integration Guide

## Overview

This document describes how to integrate with Hojai Skills Routing.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-skills-routing
...
```javascript
// GET request
const data = await fetch('http://localhost:4910/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4910/api/v1/resource', {
  method: 'POST',
  headers,
