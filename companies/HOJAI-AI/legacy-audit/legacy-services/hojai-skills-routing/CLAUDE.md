# CLAUDE.md - Hojai Skills Routing

## Project Overview

**Name:** Hojai Skills Routing
**Type:** SkillNet
**Purpose:** Hojai Skills Routing - Skill-based Contact Center Routing
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4910) |
