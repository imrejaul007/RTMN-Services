# Finance Auditor - Integration Guide

## Overview

This document describes how to integrate with Finance Auditor.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/finance-auditor
