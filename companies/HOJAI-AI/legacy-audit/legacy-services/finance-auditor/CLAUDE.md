...
**Type:** Industry AI
**Purpose:** Finance Auditor - AI/ML intelligence service
...
| GET | /audit-report/:tenantId | GET request |
| POST | /detect-fraud | POST request |
| POST | /detect-duplicate | POST request |
