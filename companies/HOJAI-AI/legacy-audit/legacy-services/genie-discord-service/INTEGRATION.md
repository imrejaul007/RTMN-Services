# Genie Discord Service - Integration Guide

## Overview

This document describes how to integrate with Genie Discord Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-discord-service
