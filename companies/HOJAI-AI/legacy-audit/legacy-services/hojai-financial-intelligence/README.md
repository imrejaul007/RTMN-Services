...
> **HOJAI Core** | HOJAI Financial Intelligence - Finance AI for Businesses
...
```bash
curl http://localhost:4754/health
```

**Response:**
```json
{"status": "healthy", "service": "hojai-financial-intelligence", "timestamp": "..."}
```
