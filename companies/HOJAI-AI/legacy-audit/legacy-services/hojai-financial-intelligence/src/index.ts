/**
 * HOJAI Financial Intelligence - Main Server
 */
...
const MONGODB_URI = process.env.MONGODB_URI || 'mongodb://localhost:27017/hojai-financial-intelligence';
...
app.get('/health', (req: Request, res: Response) => {
  res.json({ status: 'healthy', service: 'hojai-financial-intelligence', version: '1.0.0', timestamp: new Date().toISOString() });
});
