# CLAUDE.md - Hojai Financial Intelligence

## Project Overview

**Name:** Hojai Financial Intelligence
**Type:** HOJAI Core
**Purpose:** HOJAI Financial Intelligence - Finance AI for Businesses
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4754) |
...
{
  "status": "healthy",
  "service": "hojai-financial-intelligence",
  "version": "1.0.0"
}
```
