# Rez Legal Document Ai - Integration Guide

## Overview

This document describes how to integrate with Rez Legal Document Ai.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-legal-document-ai
