# Hojai Audit Logs - Integration Guide

## Overview

This document describes how to integrate with Hojai Audit Logs.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-audit-logs
