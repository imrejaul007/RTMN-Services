# Hojai Whatsapp Bsp - Integration Guide

## Overview

This document describes how to integrate with Hojai Whatsapp Bsp.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-whatsapp-bsp
...
```javascript
// GET request
const data = await fetch('http://localhost:4890/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4890/api/v1/resource', {
  method: 'POST',
  headers,
