# CLAUDE.md - Hojai Whatsapp Bsp

## Project Overview

**Name:** Hojai Whatsapp Bsp
**Type:** HOJAI Core
**Purpose:** Hojai WhatsApp BSP - Direct WhatsApp Business API Integration
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4890) |
