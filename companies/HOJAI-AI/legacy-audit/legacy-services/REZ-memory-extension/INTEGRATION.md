# Rez Memory Extension - Integration Guide

## Overview

This document describes how to integrate with Rez Memory Extension.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-memory-extension
