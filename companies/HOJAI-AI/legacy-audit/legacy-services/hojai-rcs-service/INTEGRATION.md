# Hojai Rcs Service - Integration Guide

## Overview

This document describes how to integrate with Hojai Rcs Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-rcs-service
...
```javascript
// GET request
const data = await fetch('http://localhost:4900/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4900/api/v1/resource', {
  method: 'POST',
  headers,
