# CLAUDE.md - Hojai Evaluation Studio

## Project Overview

**Name:** Hojai Evaluation Studio
**Type:** HOJAI Core
**Purpose:** HOJAI Evaluation Studio - Visual benchmark comparison, A/B testing
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4597) |
