# Rez Cosmic Twin - Integration Guide

## Overview

This document describes how to integrate with Rez Cosmic Twin.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-cosmic-twin
