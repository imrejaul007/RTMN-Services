# Sutar Intent Bus - Integration Guide

## Overview

This document describes how to integrate with Sutar Intent Bus.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/sutar-intent-bus
