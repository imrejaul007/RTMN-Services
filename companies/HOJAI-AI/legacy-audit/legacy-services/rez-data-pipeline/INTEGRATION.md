# Rez Data Pipeline - Integration Guide

## Overview

This document describes how to integrate with Rez Data Pipeline.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/rez-data-pipeline
