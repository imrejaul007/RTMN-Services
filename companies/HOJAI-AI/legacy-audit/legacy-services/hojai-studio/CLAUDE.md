# CLAUDE.md - Hojai Studio

## Project Overview

**Name:** Hojai Studio
**Type:** HOJAI Core
**Purpose:** Hojai Studio - Visual Conversation Builder for AI Agents
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4850) |
...
| GET | /api/node-types | GET request |
| GET | /api/industries | GET request |
| GET | /api/categories | GET request |
| GET | /api/action-types | GET request |
