# Hib Code Intelligence Service - Integration Guide

## Overview

This document describes how to integrate with Hib Code Intelligence Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hib-code-intelligence-service
