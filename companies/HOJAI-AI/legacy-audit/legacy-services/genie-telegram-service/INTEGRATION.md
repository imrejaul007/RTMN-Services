# Genie Telegram Service - Integration Guide

## Overview

This document describes how to integrate with Genie Telegram Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-telegram-service
