# CLAUDE.md - Hojai Sla Monitor

## Project Overview

**Name:** Hojai Sla Monitor
**Type:** HOJAI Core
**Purpose:** Hojai SLA Monitor - Service Level Agreement Monitoring
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4920) |
...
| GET | /api/slas | GET request |
| GET | /api/violations | GET request |
| GET | /api/stats | GET request |
| POST | /api/slas | POST request |
| POST | /api/check | POST request |
| POST | /api/violations/:id/acknowledge | POST request |
