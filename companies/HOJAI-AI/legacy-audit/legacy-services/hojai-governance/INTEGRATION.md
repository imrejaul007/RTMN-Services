# Hojai Governance - Integration Guide

## Overview

This document describes how to integrate with Hojai Governance.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-governance
...
```javascript
// GET request
const data = await fetch('http://localhost:4630/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4630/api/v1/resource', {
  method: 'POST',
  headers,
