...
**Type:** Industry AI
**Purpose:** Finance Accountant - AI/ML intelligence service
...
| GET | /invoices/:tenantId | GET request |
| GET | /ledger/:tenantId/:name | GET request |
| GET | /tally/export/:tenantId | GET request |
| POST | /invoice | POST request |
| POST | /ledger | POST request |
