# Finance Accountant - Integration Guide

## Overview

This document describes how to integrate with Finance Accountant.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/finance-accountant
