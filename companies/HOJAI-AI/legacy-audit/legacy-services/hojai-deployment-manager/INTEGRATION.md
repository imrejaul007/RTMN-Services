# Hojai Deployment Manager - Integration Guide

## Overview

This document describes how to integrate with Hojai Deployment Manager.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-deployment-manager
