# Voice Ecosystem - Integration Guide

## Overview

This document describes how to integrate with Voice Ecosystem.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/voice-ecosystem
