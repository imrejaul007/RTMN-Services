# Marketing Manager - Integration Guide

## Overview

This document describes how to integrate with Marketing Manager.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/marketing-manager
