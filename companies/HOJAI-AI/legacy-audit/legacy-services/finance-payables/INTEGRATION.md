# Finance Payables - Integration Guide

## Overview

This document describes how to integrate with Finance Payables.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/finance-payables
