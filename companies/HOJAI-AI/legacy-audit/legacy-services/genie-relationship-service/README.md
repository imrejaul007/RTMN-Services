...
This is the Genie relationship service service for HOJAI Genie AI.
...
```bash
docker build -t genie-relationship-service .
docker run -p 3000:3000 genie-relationship-service
```
