# Hojai Agriculture - Integration Guide

## Overview

This document describes how to integrate with Hojai Agriculture.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-agriculture
