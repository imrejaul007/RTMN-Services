# Knowledge Connectors - Integration Guide

## Overview

This document describes how to integrate with Knowledge Connectors.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/knowledge-connectors
