# Incident Management Service - Integration Guide

## Overview

This document describes how to integrate with Incident Management Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/incident-management-service
...
```javascript
// GET request
const data = await fetch('http://localhost:4602/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4602/api/v1/resource', {
  method: 'POST',
  headers,
