# Hojai Human Handoff - Integration Guide

## Overview

This document describes how to integrate with Hojai Human Handoff.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-human-handoff
