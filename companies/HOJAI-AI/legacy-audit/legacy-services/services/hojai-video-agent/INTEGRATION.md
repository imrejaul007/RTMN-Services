# Hojai Video Agent - Integration Guide

## Overview

This document describes how to integrate with Hojai Video Agent.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-video-agent
