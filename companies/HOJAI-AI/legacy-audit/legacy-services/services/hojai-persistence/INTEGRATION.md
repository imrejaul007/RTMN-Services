# Hojai Persistence - Integration Guide

## Overview

This document describes how to integrate with Hojai Persistence.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-persistence
