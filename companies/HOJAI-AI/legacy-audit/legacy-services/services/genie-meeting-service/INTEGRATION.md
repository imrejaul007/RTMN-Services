# Genie Meeting Service - Integration Guide

## Overview

This document describes how to integrate with Genie Meeting Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-meeting-service
