# Hojai Collaboration - Integration Guide

## Overview

This document describes how to integrate with Hojai Collaboration.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-collaboration
