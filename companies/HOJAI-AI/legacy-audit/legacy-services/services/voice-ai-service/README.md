...
> **Industry AI** | Voice AI Service for HOJAI AI - Recording, Transcription, Synthesis, Medical NLP
...
| GET | /api/openapi.json | GET request |
...
**Response:**
```json
{"status": "healthy", "service": "voice-ai-service", "timestamp": "..."}
```
