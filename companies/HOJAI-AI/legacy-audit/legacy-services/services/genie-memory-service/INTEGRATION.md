# Genie Memory Service - Integration Guide

## Overview

This document describes how to integrate with Genie Memory Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-memory-service
