# CLAUDE.md - Customer Memory Passport Service

## Project Overview

**Name:** Customer Memory Passport Service
**Type:** Industry AI
**Purpose:** Unified memory layer for HOJAI AI - brings all customer interactions into one place
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4595) |
...
| GET | /health/ready | GET request |
| GET | /health/live | GET request |
| GET | /api/v1 | GET request |
| GET | server | GET request |
...
{
  "status": "healthy",
  "service": "customer-memory-passport-service",
  "version": "1.0.0"
}
```
