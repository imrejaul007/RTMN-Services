# CLAUDE.md - Risk Detection Service

## Project Overview

**Name:** Risk Detection Service
**Type:** Industry AI
**Purpose:** Risk Detection Service for Fall Risk, Wound Deterioration, and Safeguarding Concerns
...
{
  "status": "healthy",
  "service": "risk-detection-service",
  "version": "1.0.0"
}
```
