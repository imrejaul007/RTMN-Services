# Leverge Intelligence - Integration Guide

## Overview

This document describes how to integrate with Leverge Intelligence.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/leverge-intelligence
