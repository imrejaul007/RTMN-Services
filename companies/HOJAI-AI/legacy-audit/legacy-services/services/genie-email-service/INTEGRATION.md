# Genie Email Service - Integration Guide

## Overview

This document describes how to integrate with Genie Email Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-email-service
