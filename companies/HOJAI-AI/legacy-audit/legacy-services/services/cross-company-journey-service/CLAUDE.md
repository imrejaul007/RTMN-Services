# CLAUDE.md - Cross Company Journey Service

## Project Overview

**Name:** Cross Company Journey Service
**Type:** Industry AI
**Purpose:** Unified Customer Journey Service - Tracks customers across ALL RTNM companies
...
{
  "status": "healthy",
  "service": "cross-company-journey-service",
  "version": "1.0.0"
}
```
