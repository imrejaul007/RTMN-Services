# Genie Browser History Service - Integration Guide

## Overview

This document describes how to integrate with Genie Browser History Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-browser-history-service
