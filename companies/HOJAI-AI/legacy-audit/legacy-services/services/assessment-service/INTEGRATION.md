# Assessment Service - Integration Guide

## Overview

This document describes how to integrate with Assessment Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/assessment-service
