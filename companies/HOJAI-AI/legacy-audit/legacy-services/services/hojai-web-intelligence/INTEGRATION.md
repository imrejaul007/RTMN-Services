# Hojai Web Intelligence - Integration Guide

## Overview

This document describes how to integrate with Hojai Web Intelligence.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-web-intelligence
