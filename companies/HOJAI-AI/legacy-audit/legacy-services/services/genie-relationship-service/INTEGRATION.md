# Genie Relationship Service - Integration Guide

## Overview

This document describes how to integrate with Genie Relationship Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-relationship-service
