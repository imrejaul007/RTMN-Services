# Hojai Replay System - Integration Guide

## Overview

This document describes how to integrate with Hojai Replay System.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-replay-system
...
```javascript
// GET request
const data = await fetch('http://localhost:4593/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4593/api/v1/resource', {
  method: 'POST',
  headers,
