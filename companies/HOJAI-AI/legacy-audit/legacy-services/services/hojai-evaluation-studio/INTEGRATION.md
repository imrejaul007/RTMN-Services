# Hojai Evaluation Studio - Integration Guide

## Overview

This document describes how to integrate with Hojai Evaluation Studio.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-evaluation-studio
