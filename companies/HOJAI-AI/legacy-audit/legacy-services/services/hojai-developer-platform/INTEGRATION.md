# Hojai Developer Platform - Integration Guide

## Overview

This document describes how to integrate with Hojai Developer Platform.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-developer-platform
