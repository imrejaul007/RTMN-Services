# Hojai Unified Inbox - Integration Guide

## Overview

This document describes how to integrate with Hojai Unified Inbox.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-unified-inbox
...
```javascript
// GET request
const data = await fetch('http://localhost:4870/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4870/api/v1/resource', {
  method: 'POST',
  headers,
