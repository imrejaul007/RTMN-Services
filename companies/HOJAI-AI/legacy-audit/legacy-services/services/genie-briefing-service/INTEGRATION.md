# Genie Briefing Service - Integration Guide

## Overview

This document describes how to integrate with Genie Briefing Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-briefing-service
