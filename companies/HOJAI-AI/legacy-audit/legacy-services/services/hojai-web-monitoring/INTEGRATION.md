# Hojai Web Monitoring - Integration Guide

## Overview

This document describes how to integrate with Hojai Web Monitoring.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-web-monitoring
