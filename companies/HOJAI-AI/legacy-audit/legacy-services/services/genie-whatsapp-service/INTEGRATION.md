# Genie Whatsapp Service - Integration Guide

## Overview

This document describes how to integrate with Genie Whatsapp Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-whatsapp-service
