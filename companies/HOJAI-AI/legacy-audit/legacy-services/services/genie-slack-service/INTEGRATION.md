# Genie Slack Service - Integration Guide

## Overview

This document describes how to integrate with Genie Slack Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-slack-service
