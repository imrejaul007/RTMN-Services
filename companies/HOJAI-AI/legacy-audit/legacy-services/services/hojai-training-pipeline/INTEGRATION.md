# Hojai Training Pipeline - Integration Guide

## Overview

This document describes how to integrate with Hojai Training Pipeline.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-training-pipeline
