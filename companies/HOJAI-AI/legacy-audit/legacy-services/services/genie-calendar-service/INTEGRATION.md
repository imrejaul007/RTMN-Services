# Genie Calendar Service - Integration Guide

## Overview

This document describes how to integrate with Genie Calendar Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-calendar-service
