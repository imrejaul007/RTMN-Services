# Hojai Monitoring Dashboard - Integration Guide

## Overview

This document describes how to integrate with Hojai Monitoring Dashboard.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-monitoring-dashboard
