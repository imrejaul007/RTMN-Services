# Hojai Agent Wallet - Integration Guide

## Overview

This document describes how to integrate with Hojai Agent Wallet.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-agent-wallet
