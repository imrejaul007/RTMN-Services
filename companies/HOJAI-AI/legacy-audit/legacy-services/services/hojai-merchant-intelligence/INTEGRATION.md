# Hojai Merchant Intelligence - Integration Guide

## Overview

This document describes how to integrate with Hojai Merchant Intelligence.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-merchant-intelligence
...
```javascript
// GET request
const data = await fetch('http://localhost:4751/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4751/api/v1/resource', {
  method: 'POST',
  headers,
