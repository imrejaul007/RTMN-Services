# Genie Standalone Services - Integration Guide

## Overview

This document describes how to integrate with Genie Standalone Services.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-standalone-services
