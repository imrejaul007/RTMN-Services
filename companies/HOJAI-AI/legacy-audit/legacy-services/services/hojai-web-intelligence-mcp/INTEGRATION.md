# Hojai Web Intelligence Mcp - Integration Guide

## Overview

This document describes how to integrate with Hojai Web Intelligence Mcp.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-web-intelligence-mcp
