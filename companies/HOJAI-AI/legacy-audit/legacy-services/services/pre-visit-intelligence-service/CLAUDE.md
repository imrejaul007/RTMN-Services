# CLAUDE.md - Pre Visit Intelligence Service

## Project Overview

**Name:** Pre Visit Intelligence Service
**Type:** Industry AI
**Purpose:** Pre-Visit Intelligence Service - Dynamic questions and preparation for doctor visits
...
{
  "status": "healthy",
  "service": "pre-visit-intelligence-service",
  "version": "1.0.0"
}
```
