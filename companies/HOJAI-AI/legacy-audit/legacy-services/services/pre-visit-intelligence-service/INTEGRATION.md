# Pre Visit Intelligence Service - Integration Guide

## Overview

This document describes how to integrate with Pre Visit Intelligence Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/pre-visit-intelligence-service
