# CLAUDE.md - Memory Intelligence Service

## Project Overview

**Name:** Memory Intelligence Service
**Type:** Industry AI
**Purpose:** Memory Intelligence Service for HOJAI AI - Longitudinal Memory, Pattern Detection, Cross-Domain Memory
