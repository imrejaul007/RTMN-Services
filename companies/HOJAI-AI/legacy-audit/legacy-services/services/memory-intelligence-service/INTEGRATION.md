# Memory Intelligence Service - Integration Guide

## Overview

This document describes how to integrate with Memory Intelligence Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/memory-intelligence-service
