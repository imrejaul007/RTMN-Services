# Family Support Service - Integration Guide

## Overview

This document describes how to integrate with Family Support Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/family-support-service
...
```javascript
// GET request
const data = await fetch('http://localhost:4599/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4599/api/v1/resource', {
  method: 'POST',
  headers,
