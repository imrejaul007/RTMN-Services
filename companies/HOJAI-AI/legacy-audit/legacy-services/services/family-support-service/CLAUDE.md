# CLAUDE.md - Family Support Service

## Project Overview

**Name:** Family Support Service
**Type:** Industry AI
**Purpose:** Family Support Integration Service - Links family/care circles to support for HOJAI AI
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4599) |
