# Hojai Voice Sdk - Integration Guide

## Overview

This document describes how to integrate with Hojai Voice Sdk.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-voice-sdk
