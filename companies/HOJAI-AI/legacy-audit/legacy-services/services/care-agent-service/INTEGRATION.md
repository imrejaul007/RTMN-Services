# Care Agent Service - Integration Guide

## Overview

This document describes how to integrate with Care Agent Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/care-agent-service
