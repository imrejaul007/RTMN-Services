# CLAUDE.md - Care Agent Service

## Project Overview

**Name:** Care Agent Service
**Type:** Industry AI
**Purpose:** Healthcare AI agent service for patient interactions, symptom assessment, and care coordination
...
| GET | /health/detailed | GET request |
| GET | /ready | GET request |
| GET | /live | GET request |
| GET | /api/docs | GET request |
