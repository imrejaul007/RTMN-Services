# Hojai Marketplace Web - Integration Guide

## Overview

This document describes how to integrate with Hojai Marketplace Web.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-marketplace-web
