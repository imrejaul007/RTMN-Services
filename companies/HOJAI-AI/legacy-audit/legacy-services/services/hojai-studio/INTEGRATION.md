# Hojai Studio - Integration Guide

## Overview

This document describes how to integrate with Hojai Studio.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-studio
...
```javascript
// GET request
const data = await fetch('http://localhost:4850/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4850/api/v1/resource', {
  method: 'POST',
  headers,
