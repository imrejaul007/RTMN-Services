# Hojai Company Intelligence - Integration Guide

## Overview

This document describes how to integrate with Hojai Company Intelligence.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-company-intelligence
