# Hojai Instagram Agent - Integration Guide

## Overview

This document describes how to integrate with Hojai Instagram Agent.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-instagram-agent
...
```javascript
// GET request
const data = await fetch('http://localhost:4930/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4930/api/v1/resource', {
  method: 'POST',
  headers,
