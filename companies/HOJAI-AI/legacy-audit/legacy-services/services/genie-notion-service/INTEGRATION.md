# Genie Notion Service - Integration Guide

## Overview

This document describes how to integrate with Genie Notion Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-notion-service
