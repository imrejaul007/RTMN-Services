# Hojai Agent Marketplace 2 - Integration Guide

## Overview

This document describes how to integrate with Hojai Agent Marketplace 2.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-agent-marketplace-2
