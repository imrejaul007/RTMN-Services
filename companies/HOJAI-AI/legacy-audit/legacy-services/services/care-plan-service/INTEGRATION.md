# Care Plan Service - Integration Guide

## Overview

This document describes how to integrate with Care Plan Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/care-plan-service
