# Journey Intelligence Service - Integration Guide

## Overview

This document describes how to integrate with Journey Intelligence Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/journey-intelligence-service
