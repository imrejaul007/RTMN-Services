# Hojai Telecom Bridge - Integration Guide

## Overview

This document describes how to integrate with Hojai Telecom Bridge.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-telecom-bridge
