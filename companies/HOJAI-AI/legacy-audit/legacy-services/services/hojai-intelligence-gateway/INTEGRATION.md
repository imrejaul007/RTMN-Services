# Hojai Intelligence Gateway - Integration Guide

## Overview

This document describes how to integrate with Hojai Intelligence Gateway.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-intelligence-gateway
