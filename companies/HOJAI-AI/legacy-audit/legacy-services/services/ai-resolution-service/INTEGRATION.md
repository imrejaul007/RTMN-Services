# Ai Resolution Service - Integration Guide

## Overview

This document describes how to integrate with Ai Resolution Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/ai-resolution-service
