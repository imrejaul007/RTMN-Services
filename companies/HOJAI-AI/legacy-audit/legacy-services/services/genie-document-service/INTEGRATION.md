# Genie Document Service - Integration Guide

## Overview

This document describes how to integrate with Genie Document Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-document-service
