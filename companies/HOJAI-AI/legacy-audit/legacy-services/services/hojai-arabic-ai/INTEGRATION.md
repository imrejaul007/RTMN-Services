# Hojai Arabic Ai - Integration Guide

## Overview

This document describes how to integrate with Hojai Arabic Ai.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-arabic-ai
