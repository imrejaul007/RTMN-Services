# Genie Call Service - Integration Guide

## Overview

This document describes how to integrate with Genie Call Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-call-service
