# Hojai Marketplace - Integration Guide

## Overview

This document describes how to integrate with Hojai Marketplace.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-marketplace
