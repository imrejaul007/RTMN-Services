...
> **Multi-Agent Evaluator - Compare agent capabilities**

## Overview

This is a SUTAR OS service providing Multi-Agent Evaluator - Compare agent capabilities.
...
```bash
cd services/sutar-multi-agent-evaluator
npm install
npm run dev
```
...
| Feature | Status |
|---------|--------|
| Capability comparison | ✅ Implemented |
| Performance scoring | ✅ Implemented |
| Selection recommendation | ✅ Implemented |
