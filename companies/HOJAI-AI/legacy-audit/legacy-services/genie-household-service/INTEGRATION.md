# Genie Household Service - Integration Guide

## Overview

This document describes how to integrate with Genie Household Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-household-service
