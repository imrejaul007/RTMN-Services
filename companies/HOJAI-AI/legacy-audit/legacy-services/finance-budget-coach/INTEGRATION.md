# Finance Budget Coach - Integration Guide

## Overview

This document describes how to integrate with Finance Budget Coach.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/finance-budget-coach
