# Genie Privacy Service - Integration Guide

## Overview

This document describes how to integrate with Genie Privacy Service.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/genie-privacy-service
