# CLAUDE.md - Hojai Telecom Bridge

## Project Overview

**Name:** Hojai Telecom Bridge
**Type:** HOJAI Core
**Purpose:** Hojai Telecom Bridge - Exotel, Knowlarity, Ozonetel Integration
...
|----------|----------|-------------|
| PORT | No | Service port (default: 4860) |
...
| POST | /api/calls | POST request |
| POST | /api/campaigns | POST request |
| POST | /api/sms | POST request |
| POST | /webhooks/exotel | POST request |
| POST | /webhooks/twilio | POST request |
