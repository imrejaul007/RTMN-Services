# CLAUDE.md - Hojai Agent Marketplace

## Project Overview

**Name:** Hojai Agent Marketplace
**Type:** Agent Platform
**Purpose:** Hojai Agent Marketplace - Pre-built Industry AI Agents
...
| GET | /api/industries | GET request |
| GET | /api/categories | GET request |
| GET | /api/tiers | GET request |
