# Hojai Expert Os - Integration Guide

## Overview

This document describes how to integrate with Hojai Expert Os.
...
```bash
export MONGODB_URI=mongodb://localhost:27017/hojai-expert-os
...
```javascript
// GET request
const data = await fetch('http://localhost:4800/api/v1/resource', {
  method: 'GET',
  headers
});

// POST request
const created = await fetch('http://localhost:4800/api/v1/resource', {
  method: 'POST',
  headers,
