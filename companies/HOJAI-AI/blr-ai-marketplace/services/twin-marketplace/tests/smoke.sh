#!/bin/bash
# twin-marketplace - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4146}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_twin_marketplace_$$_$RANDOM.json"
  if [ -n "$data" ]; then
