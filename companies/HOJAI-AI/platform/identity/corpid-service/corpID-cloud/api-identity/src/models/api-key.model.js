...
// ============ IN-MEMORY STORES ============
// SECURITY FIX (CORPID L-10): bound api-identity Maps. Webhook deliveries and
// apiKeyUsage in particular grow per-call and must be capped.
const MAX_API_KEYS = parseInt(process.env.MAX_API_KEYS || '100000', 10);
const MAX_OAUTH_CLIENTS = parseInt(process.env.MAX_OAUTH_CLIENTS || '50000', 10);
const MAX_WEBHOOKS = parseInt(process.env.MAX_WEBHOOKS || '50000', 10);
const MAX_SCOPES = parseInt(process.env.MAX_SCOPES || '1000', 10);
const MAX_WEBHOOK_DELIVERIES = parseInt(process.env.MAX_WEBHOOK_DELIVERIES || '500000', 10);
const MAX_API_KEY_USAGE = parseInt(process.env.MAX_API_KEY_USAGE || '500000', 10);

export const apiKeys = new BoundedMap(MAX_API_KEYS);
export const oauthClients = new BoundedMap(MAX_OAUTH_CLIENTS);
export const webhooks = new BoundedMap(MAX_WEBHOOKS);
export const scopes = new BoundedMap(MAX_SCOPES);
export const webhookDeliveries = new BoundedMap(MAX_WEBHOOK_DELIVERIES);
export const apiKeyUsage = new BoundedMap(MAX_API_KEY_USAGE);
