...
// ============ IN-MEMORY STORES ============
// SECURITY FIX (CORPID L-10): bound device Maps. Devices are the most
// memory-hungry map because each user typically registers multiple devices;
// without bounds this can balloon to millions of records.
const MAX_DEVICES = parseInt(process.env.MAX_DEVICES || '500000', 10);
const MAX_DEVICE_LOCATIONS = parseInt(process.env.MAX_DEVICE_LOCATIONS || '100000', 10);
const MAX_DEVICE_TRUST_HISTORY = parseInt(process.env.MAX_DEVICE_TRUST_HISTORY || '100000', 10);

export const devices = new BoundedMap(MAX_DEVICES);
export const deviceLocations = new BoundedMap(MAX_DEVICE_LOCATIONS);
export const deviceTrustHistory = new BoundedMap(MAX_DEVICE_TRUST_HISTORY);
