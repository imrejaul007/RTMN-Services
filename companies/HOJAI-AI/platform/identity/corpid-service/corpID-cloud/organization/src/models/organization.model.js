...
// SECURITY: only creates a default org in dev/test when
// CORPID_ENABLE_DEV_SEED=1. In production, organizations must be
// created via the API after admin bootstrap.
export function initializeDefaultOrganization() {
  ...
  const org = createOrganization({
    ...
    size: 'enterprise',
    plan: 'enterprise',
    ownerEmail: process.env.CORPID_DEV_OWNER_EMAIL || 'dev-admin@example.com',
    createdBy: 'system'
  });
