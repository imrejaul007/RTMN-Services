 ...
 *
 * This is the CORPID v2.0 in-memory implementation. It has been superseded by:
 *   - src/index.persistent.js  (v3.0 — ACTIVE, use this instead)
 *
 * Key differences from v3.0 (index.persistent.js):
 *   - Uses PersistentMap (in-memory, lost on restart) instead of PersistentStore
 *   - Lacks agent identity (CI-AGT-), delegation, workload identity
 *   - Lacks relationship graph, multi-dimensional trust
 *   - Single-file monolith vs. modular architecture
 *
 * This file is kept for reference only and will be removed in a future release.
 *
 * @deprecated since 2026-06-27 — use src/index.persistent.js
 * @author HOJAI AI
 * @version 2.0.0
 */
