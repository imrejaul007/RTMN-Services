...
app.post('/api/shadow/sessions', (req: Request, res: Response) => {
...
app.post('/api/shadow/sessions/:sessionId/suggest', (req: Request, res: Response) => {
...
app.post('/api/shadow/suggestions/:id/accept', (req, res) => {
...
app.post('/api/shadow/sessions/:sessionId/end', (req, res) => {
  const session = sessions.get(req.params.sessionId);
