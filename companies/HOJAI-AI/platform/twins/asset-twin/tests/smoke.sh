#!/bin/bash
# asset-twin - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4890}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_asset_twin_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  asset-twin - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/assets" GET "/api/assets" "" "" "200"
run "auto GET /api/assets/test-id" GET "/api/assets/test-id" "" "" "200"
run "auto GET /api/assets/test-id/value" GET "/api/assets/test-id/value" "" "" "200"
run "auto GET /api/categories" GET "/api/categories" "" "" "200"
run "auto POST /api/assets/test-id/maintenanc" POST "/api/assets/test-id/maintenance" '{"test":true}' "" "201"
