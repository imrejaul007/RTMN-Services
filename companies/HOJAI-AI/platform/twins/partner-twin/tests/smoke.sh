#!/bin/bash
# partner-twin - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4892}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_partner_twin_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  partner-twin - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/partners" GET "/api/partners" "" "" "200"
run "auto GET /api/partners/test-id" GET "/api/partners/test-id" "" "" "200"
run "auto GET /api/partners/test-id/analytic" GET "/api/partners/test-id/analytics" "" "" "200"
run "auto GET /api/partners/test-id/relation" GET "/api/partners/test-id/relationships" "" "" "200"
