#!/bin/bash
# employee-twin - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4730}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_employee_twin_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  employee-twin - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/employees" GET "/api/employees" "" "" "200"
run "auto GET /api/employees/test-id" GET "/api/employees/test-id" "" "" "200"
run "auto GET /api/employees/test-id/skills" GET "/api/employees/test-id/skills" "" "" "200"
run "auto GET /api/employees/test-id/perform" GET "/api/employees/test-id/performance" "" "" "200"
run "auto GET /api/employees/test-id/health" GET "/api/employees/test-id/health" "" "" "200"
run "auto GET /api/org-chart" GET "/api/org-chart" "" "" "200"
run "auto GET /api/employees/test-id/team" GET "/api/employees/test-id/team" "" "" "200"
run "auto GET /api/employees/test-id/manager" GET "/api/employees/test-id/manager" "" "" "200"
