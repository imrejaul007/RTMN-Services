#!/bin/bash
# organization-twin - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4710}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_organization_twin_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  organization-twin - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/organizations" GET "/api/organizations" "" "" "200"
run "auto GET /api/organizations/test-id" GET "/api/organizations/test-id" "" "" "200"
run "auto GET /api/organizations/test-id/dep" GET "/api/organizations/test-id/departments" "" "" "200"
run "auto PUT /api/departments/test-id" PUT "/api/departments/test-id" '{"test":true}' "" "200"
run "auto GET /api/organizations/test-id/hea" GET "/api/organizations/test-id/health" "" "" "200"
run "auto GET /api/organizations/test-id/kpi" GET "/api/organizations/test-id/kpis" "" "" "200"
run "auto GET /api/organizations/test-id/rel" GET "/api/organizations/test-id/relationships" "" "" "200"
run "auto DELETE /api/relationships/test-id" DELETE "/api/relationships/test-id" "" "" "200"
run "auto GET /api/organizations/test-id/syn" GET "/api/organizations/test-id/sync" "" "" "200"
