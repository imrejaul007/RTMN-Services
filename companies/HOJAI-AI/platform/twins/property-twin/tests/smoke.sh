#!/bin/bash
# property-twin - Auto-generated smoke tests
set -u
...
run() {
  ...
  local body_file="${TMPDIR}/_property_twin_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  property-twin - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/twins" GET "/api/twins" "" "" "200"
run "auto GET /api/twin/test-id" GET "/api/twin/test-id" "" "" "200"
run "auto POST /api/twin" POST "/api/twin" '{"test":true}' "" "201"
run "auto PATCH /api/twin/test-id/state" PATCH "/api/twin/test-id/state" '{"test":true}' "" "200"
run "auto GET /api/twin/test-id/history" GET "/api/twin/test-id/history" "" "" "200"
