/**
 * Capability Store Tests - Port 4804
 */
import { describe, it, expect } from 'vitest';
import http from 'http';

const BASE_URL = 'http://localhost:4804';
...
describe('CapabilityStore Health', () => {
...
describe('CapabilityStore Capabilities', () => {
  it('should list capabilities', async () => {
    const res = await req('/api/capabilities');
