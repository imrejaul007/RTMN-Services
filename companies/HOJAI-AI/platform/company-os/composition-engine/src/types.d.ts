 ...
 */
export type IndustryType = 'restaurant' | 'beauty' | 'healthcare' | 'retail' | 'hotel' | 'education' | 'realestate' | 'fitness' | 'legal' | 'construction' | 'manufacturing' | 'logistics' | 'automotive' | 'fashion' | 'sports' | 'entertainment' | 'travel' | 'government' | 'agriculture' | 'nonprofit' | 'professional' | 'home_services' | 'gaming' | 'media';
export type DepartmentType = 'finance' | 'hr' | 'marketing' | 'sales' | 'operations' | 'legal';
export type ExtensionType = 'pos' | 'kitchen' | 'reservations' | 'delivery' | 'recipes' | 'services' | 'stylists' | 'appointments' | 'memberships' | 'patients' | 'doctors' | 'emr' | 'prescriptions' | 'catalog' | 'inventory' | 'stores' | 'promotions' | 'rooms' | 'housekeeping' | 'concierge' | 'billing' | 'courses' | 'students' | 'assessments' | 'certificates' | string;
...
export declare function createCompanyId(prefix?: string): string;
export declare function createTwinId(companyId: string, type: string): string;
export declare function createWorkerId(department: DepartmentType, workerType: string): string;
