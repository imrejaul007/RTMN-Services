...
describe('Home_services Extension', () => {
  const tenantId = 'test_home_services_001';
  ...
  describe('Health Check', () => {
    it('should respond to health check', async () => {
      ...
      expect(response.body.service).toContain('home_services');
    });
  });
