...
describe('Entertainment Extension', () => {
  const tenantId = 'test_entertainment_001';
  ...
  describe('Health Check', () => {
    it('should respond to health check', async () => {
      ...
      expect(response.body.service).toContain('entertainment');
    });
  });
