#!/bin/bash
# sla-manager - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4873}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_sla_manager_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  sla-manager - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/policies" GET "/api/policies" "" "" "200"
run "auto GET /api/policies/test-id" GET "/api/policies/test-id" "" "" "200"
run "auto GET /api/agreements" GET "/api/agreements" "" "" "200"
run "auto GET /api/agreements/test-id" GET "/api/agreements/test-id" "" "" "200"
run "auto GET /api/breaches" GET "/api/breaches" "" "" "200"
run "auto POST /api/breaches/test-id/resolve" POST "/api/breaches/test-id/resolve" '{"test":true}' "" "201"
run "auto GET /api/agreements/test-id/compli" GET "/api/agreements/test-id/compliance" "" "" "200"
