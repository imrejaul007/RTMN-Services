...
const webhookQueue: Map<string, QueuedWebhook> = new PersistentMap('collection-1', { serviceName: 'billing' });
...
app.post('/api/v1/webhooks/:eventId/retry',requireAuth,  async (req, res) => {
...
// Clear webhook queue
app.delete('/api/v1/webhooks/queue',requireAuth,  (req, res) => {
...
app.post('/api/v1/checkout',requireAuth,  async (req, res) => {
...
app.post('/api/v1/portal',requireAuth,  async (req, res) => {
...
// Cancel subscription
app.post('/api/v1/subscription/:customerId/cancel',requireAuth,  async (req, res) => {
  const { customerId } = req.params;
...
// Update subscription
app.post('/api/v1/subscription/:customerId/update',requireAuth,  async (req, res) => {
  const { customerId } = req.params;
...
app.post('/api/v1/usage/:subscriptionItemId',requireAuth,  async (req, res) => {
...
// Create customer
app.post('/api/v1/customer',requireAuth,  async (req, res) => {
...
// Update customer
app.patch('/api/v1/customer/:customerId',requireAuth,  async (req, res) => {
  const { customerId } = req.params;
  const { email, name, metadata } = req.body;
...
app.post('/api/v1/payment-methods/:customerId/attach',requireAuth,  async (req, res) => {
  const { customerId } = req.params;
...
app.post('/api/v1/payment-methods/:paymentMethodId/detach',requireAuth,  async (req, res) => {
