...
// Register new user
app.post('/api/v1/auth/register',requireAuth,  async (req, res) => {
...
// Login
app.post('/api/v1/auth/login',requireAuth,  async (req, res) => {
...
// Verify email
app.post('/api/v1/auth/verify-email',requireAuth,  (req, res) => {
...
app.post('/api/v1/auth/resend-verification',requireAuth,  (req, res) => {
...
// Forgot password
app.post('/api/v1/auth/forgot-password',requireAuth,  (req, res) => {
  const { email } = req.body;
...
// Reset password
app.post('/api/v1/auth/reset-password',requireAuth,  async (req, res) => {
...
// Update workspace
app.patch('/api/v1/workspace/:id',requireAuth,  (req, res) => {
  const workspace = workspaces.get(req.params.id);
  if (!workspace) {
    return res.status(404).json({
      error: { code: 'NOT_FOUND', message: 'Workspace not found' }
...
app.post('/api/v1/onboarding/:workspaceId/steps/:stepId/complete',requireAuth,  (req, res) => {
...
// Create brand
app.post('/api/v1/onboarding/:workspaceId/brands',requireAuth,  (req, res) => {
  const { workspaceId } = req.params;
...
// Update brand
app.patch('/api/v1/brands/:brandId',requireAuth,  (req, res) => {
...
// Delete brand
app.delete('/api/v1/brands/:brandId',requireAuth,  (req, res) => {
...
// Add review source
app.post('/api/v1/onboarding/:workspaceId/sources',requireAuth,  (req, res) => {
  const { workspaceId } = req.params;
...
app.post('/api/v1/sources/:sourceId/verify',requireAuth,  (req, res) => {
...
// Sync review source
app.post('/api/v1/sources/:sourceId/sync',requireAuth,  async (req, res) => {
  const { sourceId } = req.params;
...
app.delete('/api/v1/sources/:sourceId',requireAuth,  (req, res) => {
  const { sourceId } = req.params;
...
// Invite team member
app.post('/api/v1/workspace/:id/invite',requireAuth,  (req, res) => {
  const { id } = req.params;
...
// Accept invitation
app.post('/api/v1/invite/:token/accept',requireAuth,  async (req, res) => {
...
app.patch('/api/v1/team/:memberId',requireAuth,  (req, res) => {
...
// Remove team member
app.delete('/api/v1/team/:memberId',requireAuth,  (req, res) => {
  const { memberId } = req.params;
...
// Resend invitation
app.post('/api/v1/team/:memberId/resend',requireAuth,  (req, res) => {
  const { memberId } = req.params;
