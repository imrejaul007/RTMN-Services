#!/bin/bash
# knowledge-marketplace - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4461}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_knowledge_marketplace_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  knowledge-marketplace - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/knowledge" GET "/api/knowledge" "" "" "200"
run "auto GET /api/knowledge/test-id" GET "/api/knowledge/test-id" "" "" "200"
run "auto GET /api/categories" GET "/api/categories" "" "" "200"
run "auto GET /api/knowledge/featured/list" GET "/api/knowledge/featured/list" "" "" "200"
run "auto GET /api/search" GET "/api/search" "" "" "200"
run "auto GET /api/industries" GET "/api/industries" "" "" "200"
run "auto POST /api/knowledge/test-id/purchas" POST "/api/knowledge/test-id/purchase" '{"test":true}' "" "201"
run "auto GET /api/purchases" GET "/api/purchases" "" "" "200"
run "auto GET /api/knowledge/test-id/downloa" GET "/api/knowledge/test-id/download" "" "" "200"
run "auto POST /api/knowledge/test-id/reviews" POST "/api/knowledge/test-id/reviews" '{"test":true}' "" "201"
run "auto GET /api/creator/packs" GET "/api/creator/packs" "" "" "200"
