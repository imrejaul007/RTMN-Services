#!/bin/bash
# reasoning-runtime - Auto-generated smoke tests
set -u
...
run() {
  ...
  local body_file="${TMPDIR}/_reasoning_runtime_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  reasoning-runtime - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /" GET "/" "" "" "200"
run "auto GET /api/templates" GET "/api/templates" "" "" "200"
run "auto GET /api/templates/test-name" GET "/api/templates/test-name" "" "" "200"
run "auto POST /api/traces" POST "/api/traces" '{"test":true}' "" "201"
run "auto GET /api/traces/test-id" GET "/api/traces/test-id" "" "" "200"
