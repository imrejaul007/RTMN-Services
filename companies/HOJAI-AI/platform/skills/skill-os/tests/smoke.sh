#!/bin/bash
# skill-os - Auto-generated smoke tests
set -u
...
run "auto POST /api/skills" POST "/api/skills" '{"test":true}' "" "201"
run "auto GET /api/skills/categories" GET "/api/skills/categories" "" "" "200"
run "auto GET /api/skills/discover" GET "/api/skills/discover" "" "" "200"
run "auto GET /api/skills/marketplace" GET "/api/skills/marketplace" "" "" "200"
run "auto GET /api/skills/test-id" GET "/api/skills/test-id" "" "" "200"
run "auto POST /api/skills/test-id/execute" POST "/api/skills/test-id/execute" '{"test":true}' "" "201"
run "auto POST /api/skills/compose" POST "/api/skills/compose" '{"test":true}' "" "201"
run "auto POST /api/skills/test-id/learn" POST "/api/skills/test-id/learn" '{"test":true}' "" "201"
run "auto POST /api/skills/test-id/versions" POST "/api/skills/test-id/versions" '{"test":true}' "" "201"
run "auto POST /api/skills/test-id/permission" POST "/api/skills/test-id/permissions" '{"test":true}' "" "201"
