#!/bin/bash
# industry-packs - Auto-generated smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4637}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_industry_packs_$$_$RANDOM.json"
  if [ -n "$data" ]; then
