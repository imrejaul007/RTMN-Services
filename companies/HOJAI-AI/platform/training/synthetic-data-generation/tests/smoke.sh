#!/bin/bash
# synthetic-data-generation - Auto-generated smoke tests
set -u
...
run() {
  ...
  local body_file="${TMPDIR}/_synthetic_data_generation_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  synthetic-data-generation - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /api/health" GET "/api/health" "" "" "200"
run "auto POST /api/generate" POST "/api/generate" '{"test":true}' "" "201"
run "auto GET /api/datasets" GET "/api/datasets" "" "" "200"
run "auto GET /api/datasets/test-id" GET "/api/datasets/test-id" "" "" "200"
run "auto GET /api/domains" GET "/api/domains" "" "" "200"
