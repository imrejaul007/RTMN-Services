...
const REQUIRE_AUTH = (process.env.FLOW_REQUIRE_AUTH ?? 'true').toLowerCase() !== 'false';

// authOrBypass — when FLOW_REQUIRE_AUTH=false (dev mode), the middleware
// is a no-op. Production must keep FLOW_REQUIRE_AUTH unset or true.
...
// Gated listen — skip in test mode or when FLOW_NO_LISTEN is set,
