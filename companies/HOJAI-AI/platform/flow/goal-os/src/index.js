...
// ============= AUTH + DATABASE =============
const authBusinesses = new PersistentMap('auth-businesses', { serviceName: 'goal-os' });
const authUsers = new PersistentMap('auth-users', { serviceName: 'goal-os' });
const authSessions = new PersistentMap('auth-sessions', { serviceName: 'goal-os' });
