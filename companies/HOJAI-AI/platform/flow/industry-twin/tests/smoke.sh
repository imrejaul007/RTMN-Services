#!/bin/bash
# Industry Twin - Smoke tests
set -u
BASE_URL="${BASE_URL:-http://localhost:4893}"
PASS=0; FAIL=0
TMPDIR="${TMPDIR:-/tmp}"
...
run() {
  ...
  local body_file="${TMPDIR}/_itw_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  Industry Twin - Smoke"
echo "============================================"

run "health"              GET  "/health"                       "" "healthy"
run "all industries"      GET  "/api/industries"               "" "Restaurant"
run "industry restaurant" GET  "/api/industries/restaurant"    "" "Restaurant"
run "industry hotel"      GET  "/api/industries/hotel"         "" "Hotel"
run "industry healthcare" GET  "/api/industries/healthcare"    "" "Healthcare"
run "industry retail"     GET  "/api/industries/retail"        "" "Retail"
