/**
 * CultureOS Tests - Port 4870
 */
import { describe, it, expect } from 'vitest';
import http from 'http';

const BASE_URL = 'http://localhost:4870';
...
describe('CultureOS Norms', () => {
  it('should list norms', async () => {
    const res = await req('/api/norms');
