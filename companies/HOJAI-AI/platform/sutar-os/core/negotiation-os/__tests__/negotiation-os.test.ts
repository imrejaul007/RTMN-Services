/**
 * NegotiationOS Tests - Port 4869
 */
import { describe, it, expect } from 'vitest';
import http from 'http';

const BASE_URL = 'http://localhost:4869';
...
describe('NegotiationOS Negotiations', () => {
  it('should list negotiations', async () => {
    const res = await req('/api/negotiations');
