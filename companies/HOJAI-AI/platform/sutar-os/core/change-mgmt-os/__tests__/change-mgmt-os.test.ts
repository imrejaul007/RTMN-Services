/**
 * ChangeManagementOS Tests - Port 4864
 */
import { describe, it, expect } from 'vitest';
import http from 'http';

const BASE_URL = 'http://localhost:4864';
...
describe('ChangeManagementOS Health', () => {
...
describe('ChangeManagementOS Changes', () => {
  it('should list changes', async () => {
    const res = await req('/api/changes');
