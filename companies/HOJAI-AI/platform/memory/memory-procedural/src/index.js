...
app.post('/api/skills/:id/execute', requireInternal, (req, res) => {
...
app.post('/api/best-practices', requireInternal, (req, res) => {
...
app.post('/api/behaviors', requireInternal, (req, res) => {
