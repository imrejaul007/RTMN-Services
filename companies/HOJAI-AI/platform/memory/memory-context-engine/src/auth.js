/**
 * Thin re-export shim for memory-context-engine (ESM).
 *
...
/**
 * Default middleware instance for memory-context-engine. /api/auth/toggle
 * is always public so the e2e smoke tests can flip REQUIRE_AUTH at runtime.
 */
