#!/bin/bash
# trust-network - Auto-generated smoke tests
set -u
...
run() {
  ...
  local body_file="${TMPDIR}/_trust_network_$$_$RANDOM.json"
  if [ -n "$data" ]; then
...
echo "============================================"
echo "  trust-network - Smoke"
echo "============================================"

run "auto GET /health" GET "/health" "" "" "200"
run "auto GET /" GET "/" "" "" "200"
run "auto GET /api/entities" GET "/api/entities" "" "" "200"
run "auto GET /api/entities/test-id" GET "/api/entities/test-id" "" "" "200"
run "auto POST /api/endorsements" POST "/api/endorsements" '{"test":true}' "" "201"
run "auto POST /api/risk-flags" POST "/api/risk-flags" '{"test":true}' "" "201"
run "auto POST /api/verifications" POST "/api/verifications" '{"test":true}' "" "201"
run "auto GET /api/top-trusted" GET "/api/top-trusted" "" "" "200"
