...
// In-memory storage
const notifications = new PersistentMap('notifications', { serviceName: 'notification-service' });
const templates = new PersistentMap('templates', { serviceName: 'notification-service' });
const subscriptions = new PersistentMap('subscriptions', { serviceName: 'notification-service' });
const channels = new PersistentMap('channels', { serviceName: 'notification-service' });
...
app.post('/api/templates/:id/preview',requireAuth,  (req, res) => {
  const template = templates.get(req.params.id);
...
app.put('/api/channels/:channel',requireAuth,  (req, res) => {
...
// Test channel
app.post('/api/channels/:channel/test',requireAuth,  (req, res) => {
...
app.post('/api/notifications/bulk',requireAuth,  (req, res) => {
